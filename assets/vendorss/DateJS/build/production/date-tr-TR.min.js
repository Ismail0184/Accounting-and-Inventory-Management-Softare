...
Date.CultureStrings["tr-TR"]={name:"tr-TR",englishName:"Turkish (Turkey)",nativeName:"T\u00fcrk\u00e7e (T\u00fcrkiye)",Sunday:"Pazar",Monday:"Pazartesi",Tuesday:"Sal\u0131",Wednesday:"\u00c7ar\u015famba",Thursday:"Per\u015fembe",Friday:"Cuma",Saturday:"Cumartesi",Sun:"Paz",Mon:"Pzt",Tue:"Sal",Wed:"\u00c7ar",Thu:"Per",Fri:"Cum",Sat:"Cmt",Su:"Pz",Mo:"Pt",Tu:"Sa",We:"\u00c7a",Th:"Pe",Fr:"Cu",Sa:"Ct",S_Sun_Initial:"P",M_Mon_Initial:"P",T_Tue_Initial:"S",W_Wed_Initial:"\u00c7",T_Thu_Initial:"P",F_Fri_Initial:"C",
S_Sat_Initial:"C",January:"Ocak",February:"\u015eubat",March:"Mart",April:"Nisan",May:"May\u0131s",June:"Haziran",July:"Temmuz",August:"A\u011fustos",September:"Eyl\u00fcl",October:"Ekim",November:"Kas\u0131m",December:"Aral\u0131k",Jan_Abbr:"Oca",Feb_Abbr:"\u015eub",Mar_Abbr:"Mar",Apr_Abbr:"Nis",May_Abbr:"May",Jun_Abbr:"Haz",Jul_Abbr:"Tem",Aug_Abbr:"A\u011fu",Sep_Abbr:"Eyl",Oct_Abbr:"Eki",Nov_Abbr:"Kas",Dec_Abbr:"Ara",AM:"",PM:"",firstDayOfWeek:1,twoDigitYearMax:2029,mdy:"dmy","M/d/yyyy":"dd.MM.yyyy",
"dddd, MMMM dd, yyyy":"dd MMMM yyyy dddd","h:mm tt":"HH:mm","h:mm:ss tt":"HH:mm:ss","dddd, MMMM dd, yyyy h:mm:ss tt":"dd MMMM yyyy dddd HH:mm:ss","yyyy-MM-ddTHH:mm:ss":"yyyy-MM-ddTHH:mm:ss","yyyy-MM-dd HH:mm:ssZ":"yyyy-MM-dd HH:mm:ssZ","ddd, dd MMM yyyy HH:mm:ss":"ddd, dd MMM yyyy HH:mm:ss","MMMM dd":"dd MMMM","MMMM, yyyy":"MMMM yyyy","/jan(uary)?/":"oca(k)?","/feb(ruary)?/":"\u015fub(at)?","/mar(ch)?/":"mar(t)?","/apr(il)?/":"nis(an)?","/may/":"may(\u0131s)?","/jun(e)?/":"haz(iran)?","/jul(y)?/":"tem(muz)?",
"/aug(ust)?/":"a\u011fu(stos)?","/sep(t(ember)?)?/":"eyl(\u00fcl)?","/oct(ober)?/":"eki(m)?","/nov(ember)?/":"kas(\u0131m)?","/dec(ember)?/":"ara(l\u0131k)?","/^su(n(day)?)?/":"^pz(z(ar)?)?","/^mo(n(day)?)?/":"^pt(t(artesi)?)?","/^tu(e(s(day)?)?)?/":"^sa(l(\u0131)?)?","/^we(d(nesday)?)?/":"^\u00e7a(r(\u015famba)?)?","/^th(u(r(s(day)?)?)?)?/":"^pe(r(\u015fembe)?)?","/^fr(i(day)?)?/":"^cu(m(a)?)?","/^sa(t(urday)?)?/":"^ct(t(artesi)?)?","/^next/":"^next","/^last|past|prev(ious)?/":"^last|past|prev(ious)?",
