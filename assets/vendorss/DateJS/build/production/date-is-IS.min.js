...
Date.CultureStrings["is-IS"]={name:"is-IS",englishName:"Icelandic (Iceland)",nativeName:"\u00edslenska (\u00cdsland)",Sunday:"sunnudagur",Monday:"m\u00e1nudagur",Tuesday:"\u00feri\u00f0judagur",Wednesday:"mi\u00f0vikudagur",Thursday:"fimmtudagur",Friday:"f\u00f6studagur",Saturday:"laugardagur",Sun:"sun.",Mon:"m\u00e1n.",Tue:"\u00feri.",Wed:"mi\u00f0.",Thu:"fim.",Fri:"f\u00f6s.",Sat:"lau.",Su:"su",Mo:"m\u00e1",Tu:"\u00fer",We:"mi",Th:"fi",Fr:"f\u00f6",Sa:"la",S_Sun_Initial:"s",M_Mon_Initial:"m",T_Tue_Initial:"\u00fe",
W_Wed_Initial:"m",T_Thu_Initial:"f",F_Fri_Initial:"f",S_Sat_Initial:"l",January:"jan\u00faar",February:"febr\u00faar",March:"mars",April:"apr\u00edl",May:"ma\u00ed",June:"j\u00fan\u00ed",July:"j\u00fal\u00ed",August:"\u00e1g\u00fast",September:"september",October:"okt\u00f3ber",November:"n\u00f3vember",December:"desember",Jan_Abbr:"jan.",Feb_Abbr:"feb.",Mar_Abbr:"mar.",Apr_Abbr:"apr.",May_Abbr:"ma\u00ed",Jun_Abbr:"j\u00fan.",Jul_Abbr:"j\u00fal.",Aug_Abbr:"\u00e1g\u00fa.",Sep_Abbr:"sep.",Oct_Abbr:"okt.",
Nov_Abbr:"n\u00f3v.",Dec_Abbr:"des.",AM:"",PM:"",firstDayOfWeek:1,twoDigitYearMax:2029,mdy:"dmy","M/d/yyyy":"d.M.yyyy","dddd, MMMM dd, yyyy":"d. MMMM yyyy","h:mm tt":"HH:mm","h:mm:ss tt":"HH:mm:ss","dddd, MMMM dd, yyyy h:mm:ss tt":"d. MMMM yyyy HH:mm:ss","yyyy-MM-ddTHH:mm:ss":"yyyy-MM-ddTHH:mm:ss","yyyy-MM-dd HH:mm:ssZ":"yyyy-MM-dd HH:mm:ssZ","ddd, dd MMM yyyy HH:mm:ss":"ddd, dd MMM yyyy HH:mm:ss","MMMM dd":"d. MMMM","MMMM, yyyy":"MMMM yyyy","/jan(uary)?/":"jan(.(\u00faar)?)?","/feb(ruary)?/":"feb(.(r\u00faar)?)?",
"/mar(ch)?/":"mar(.(s)?)?","/apr(il)?/":"apr(.(\u00edl)?)?","/may/":"ma\u00ed","/jun(e)?/":"j\u00fan(.(\u00ed)?)?","/jul(y)?/":"j\u00fal(.(\u00ed)?)?","/aug(ust)?/":"\u00e1g\u00fa(.(st)?)?","/sep(t(ember)?)?/":"sep(t(ember)?)?","/oct(ober)?/":"okt(.(\u00f3ber)?)?","/nov(ember)?/":"n\u00f3v(.(ember)?)?","/dec(ember)?/":"des(.(ember)?)?","/^su(n(day)?)?/":"^su(n(.(nudagur)?)?)?","/^mo(n(day)?)?/":"^m\u00e1(n(.(udagur)?)?)?","/^tu(e(s(day)?)?)?/":"^\u00fer(i(.(\u00f0judagur)?)?)?","/^we(d(nesday)?)?/":"^mi(\u00f0(.(vikudagur)?)?)?",
"/^th(u(r(s(day)?)?)?)?/":"^fi(m(.(mtudagur)?)?)?","/^fr(i(day)?)?/":"^f\u00f6(s(.(tudagur)?)?)?","/^sa(t(urday)?)?/":"^la(u(.(gardagur)?)?)?","/^next/":"^next","/^last|past|prev(ious)?/":"^last|past|prev(ious)?","/^(\\+|aft(er)?|from|hence)/":"^(\\+|aft(er)?|from|hence)","/^(\\-|bef(ore)?|ago)/":"^(\\-|bef(ore)?|ago)","/^yes(terday)?/":"^yes(terday)?","/^t(od(ay)?)?/":"^t(od(ay)?)?","/^tom(orrow)?/":"^tom(orrow)?","/^n(ow)?/":"^n(ow)?","/^ms|milli(second)?s?/":"^ms|milli(second)?s?","/^sec(ond)?s?/":"^sec(ond)?s?",
...
BST:"BST",PMDT:"PMDT",ADT:"ADT",NDT:"NDT",EDT:"EDT",CDT:"CDT",MDT:"MDT",PDT:"PDT",AKDT:"AKDT",HADT:"HADT"};Date.CultureStrings.lang="is-IS";
