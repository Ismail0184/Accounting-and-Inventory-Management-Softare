                ...
                <div class="x_content">
                    ...
                    <table  class="table table-striped table-bordered" style="width:100%; font-size: 11px">
                        ...
                        <tr style="background-color: bisque">
                            ...
                            <th style="text-align:center;vertical-align: middle">Sub Group</th>
                        ...
                        <?php
                        while($row=mysqli_fetch_array($res_item)){
                            $mysqli=mysqli_query($conn, "select * from item_landad_cost where item_id=".$row[item_id]." and status='Active'");
                            $landed_cost=mysqli_fetch_array($mysqli);
                            $id=$row[item_id];

                            $grn=mysqli_query($conn, "Select SUM(qty) as qty,SUM(total_cost_against_GRN) as total_cost_against_GRN from purchase_receive where item_id=".$row[item_id]." order by id desc limit 10");
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle" align="left" ><a href="accounts_material_landed_cost_one.php?item_id=<?=$row[item_id];?>" target="_blank"><?php echo $row[item_name]; ?></a></td>
                                <td style="vertical-align: middle" align="left" ><?php echo $row[sub_group_name]; ?></td>
                                <td style="vertical-align: middle" align="left" ><?php echo $row[group_name]; ?></td>
                                ...
                                <td style="vertical-align: middle" align="center" style="vertical-align: middle">
                                    <?php if($landed_cost[landad_cost]>0){ echo $landed_cost[landad_cost];} else { ?>
                                ...
                                <td style="vertical-align: middle" align="center" ><?=$landed_cost[entry_date];?></td>
