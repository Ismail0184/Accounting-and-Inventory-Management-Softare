...
$now=time();
$unique='ZONE_CODE';
$unique_field='ZONE_NAME';
$table="zon";
$page="sales_market_setup_area.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
$title='Area Setup';
...
$res="SELECT ar.ZONE_CODE,ar.ZONE_NAME as area_name,(select PBI_NAME from personnel_basic_info where PBI_ID=ar.area_asm_name) as Area_Manager,r.BRANCH_NAME as region_name,(select PBI_NAME from personnel_basic_info where PBI_ID=r.branch_rsm_name) as regional_manager,if(ar.status>0, 'Active','Inactive') as status from ".$table." ar,branch r where ar.REGION_ID=r.BRANCH_ID";
                            ...
                            <form  name="addem" id="addem" class="form-horizontal form-label-left" style="font-size: 11px" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12" style="width: 60%">
                                        ...
                                        <input type="text" id="ZONE_NAME" style="width:100%; font-size: 12px"  required   name="ZONE_NAME" value="<?=$ZONE_NAME;?>" class="form-control col-md-7 col-xs-12" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 30%">Area Sales Manager<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12" style="width: 60%">
                                        <select class="select2_single form-control" style="width: 100%;" tabindex="-1" required="required" name="area_asm_name" id="area_asm_name">
                                            <option></option>
                                            <?=advance_foreign_relation($sql_user_id,$area_asm_name);?>
                                        </select>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 30%">Region<span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12" style="width: 60%">
                                        <select class="select2_single form-control" style="width: 100%;" tabindex="-1" required="required" name="REGION_ID" id="REGION_ID">
                                            <option></option>
                                            <?php foreign_relation('branch', 'BRANCH_ID', 'CONCAT(BRANCH_ID," : ", BRANCH_NAME)', $REGION_ID, '1'); ?>
                                        </select>
                                    </div>
                                </div>
