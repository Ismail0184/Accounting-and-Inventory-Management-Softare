...
mysql_query("Update inventory_groups SET 
country='$country', 
groups='$groups',
...
?>
<meta http-equiv="refresh" content="0;inventory_groups.php">
<?php } ?>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="x_content">
                   ...
                   <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Vendor To<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<?php if($_GET[type]){ ?>
                        <input type="text" id="first-name" required="required" value="<?php echo $rowsmaingroup[vendorid] ?>" name="vendorid" class="form-control col-md-7 col-xs-12" readonly><?php } else { ?>
                        <select id="first-name" required="required"   name="vendorid" class="form-control col-md-7 col-xs-12">
                 ...
                 <option value="<?php echo $rowmaingroup[id]; ?>"><?php echo $rowmaingroup[sname]; ?></option>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="last-name" name="tandc" class="form-control col-md-7 col-xs-12">All Cheque payment shall be made payable to: S.S Corporation. VAT and TAX will be paid by Customer. Place of Delivery from S.S Corporation, 53 Nawabpur, Dhaka-1100. Delivery to 7 days after getting work order or confirmation.</textarea>
                        </div>
                      </div>        
...
if ($valid){
	if($qtys>0){
 $result=mysql_query("INSERT INTO `sales_quotations` (quotationsref,subject,dateofissue,dateofexpire,mrp,tandc,vendorid,inventory_types,categoryid,category,brandid,brand,modelid,model,productcode,product,qty,rate,amount,unit,remarks,companyid,createby,createdate,ip,mac) VALUES 
 ('$quotationsref','$subject','$dateofissue','$dateofexpire','$mrp','$tandc','$vendorid','$inventory_types','$categoryid','$category','$brandid','$brand','$modelid','$model','$ids','$product','$qtys','$rate','$amount','$unit','$remarks','$companyid','$createby','$createdate','$ip','$mac')");
 

 salesquotationrefno();
  ?>
	<meta http-equiv="refresh" content="0;sales_quotation.php">
<?php }}}
