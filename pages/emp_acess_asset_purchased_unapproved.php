...
$page="emp_acess_asset_purchased_unapproved.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
         ...
         <div class="x_panel">
          ...
          <table style="width:100%; font-size: 11px" class="table table-striped table-bordered">
				 ...
				 (SELECT concat(p2.PBI_NAME," # ","(",de.DESG_SHORT_NAME,")") FROM 
				  ...
				  r.recommended='.$_SESSION['PBI_ID'].' and
...
mail($to,$subject,$txt,$headers); 
                       ...
                       echo "<script>window.close(); </script>";
								...
								?>
                                     ...
                                     <?php if($current_status!=$required_status){ echo '<h6 style="text-align:center; color:red; font-weight:bold"><i>This purchase order has been recommended!!</i></h6>';} else { ?>
                                           ...
                                           <button type="submit" style="font-size:12px; float:right" onclick='return window.confirm("Are you confirm to Recommend the AP?");' name="checked" id="checked" class="btn btn-success">Recommended & Forward</button>
