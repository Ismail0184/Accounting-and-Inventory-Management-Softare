                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                if(isset($initiate)){
                                    ...
                                    add_to_journal_master($invoice,$transaction_date, $_POST[r_from], $_POST[c_no], $c_date, $_POST[bank], MANUAL, $_POST[remarks],Contra,$_POST[PBI_ID],$ip);
                                    $_SESSION[initiate_contra_note]=$invoice;
                                }


                                if(isset($_POST[updateMAN])){
                                    journal_master_update($transaction_date,$_POST[r_from], $_POST[c_no], $c_date,$_POST[bank],$_POST[remarks],$_POST[PBI_ID],$_SESSION[initiate_contra_note]); ?>
                                    <meta http-equiv="refresh" content="0;contra_note.php">
                               <?php  }
                                $resultsssss=mysql_query("Select * from journal_voucher_master where voucherno='$_SESSION[initiate_contra_note]'");
                                    ...
                                    <table align="center" style="width:100%">
                                        <tr>
                                            <td style="width:50%;">
                                                <div class="form-group" style="width: 100%">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="nam_date"  required="required" name="nam_date" value="<?php if($_SESSION[initiate_contra_note]){ echo date('m/d/y' , strtotime($inirow[voucher_date])); } else { echo ''; } ?>" class="form-control col-md-7 col-xs-12" style="width: 130px; font-size: 11px" ><br>
                                            ...
                                            <td style="width:50%"><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="last-name"   required="required" name="invoice" value="<?php if($_SESSION[initiate_contra_note]){ echo $inirow[voucherno];} else { echo


                                                        $_SESSION['CONNONEW']; } ?>" class="form-control col-md-7 col-xs-12"  readonly style="width: 130px; font-size: 11px">
                                                    </div>
                                                </div>
                                            </td></tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="text" id="r_from"  value="<?php if($_SESSION[initiate_contra_note]){ echo $inirow[paid_to];} else { echo ''; } ?>" name="r_from" class="form-control col-md-7 col-xs-12" required style="width: 130px; margin-top: 5px; font-size: 11px" >
                                                    </div></div></td>
                                            ...
                                            <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="PBI_ID"  value="<?php if($_SESSION[initiate_contra_note]){ echo $inirow[PBI_ID];} else { echo ''; } ?>" name="PBI_ID" class="form-control col-md-7 col-xs-12"  style="width: 130px; margin-top: 5px; font-size: 11px">
                                                    </div></div></td></tr>
                                        ...
                                        <tr> <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="c_no"  value="<?php if($_SESSION[initiate_contra_note]){ echo $inirow[Cheque_No];} else { echo ''; } ?>" name="c_no"  class="form-control col-md-7 col-xs-12" style="width: 130px; margin-top: 5px; font-size: 11px" ></div></div></td>
                                            ...
                                            <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="text" id="c_date"   value="<?php if($_SESSION[initiate_contra_note]){ echo date('m/d/y' , strtotime($inirow[Cheque_Date]));} else { echo ''; } ?>" name="c_date"  class="form-control col-md-7 col-xs-12"  style="width: 130px; margin-top: 5px; font-size: 11px">
                                                    </div></div></td></tr>
                                    ...
                                    <div class="form-group" style="margin-left:40%; margin-top: 15px">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <?php if($_SESSION[initiate_contra_note]){  ?>
                                                ...
                                                <button type="submit" name="updateMAN" class="btn btn-primary" onclick='return window.confirm("Are you confirm to Update?");'>Update Contra Voucher</button>

                                            <?php   } else {?>
                                                <button type="submit" name="initiate" class="btn btn-primary">Initiate Contra Voucher</button>
                                            <?php } ?>
                                        </div></div>
                                </form></div></div></div>
...
from  journal a where a.tr_from='Contra' and a.user_id='$_SESSION[userid]'  group by a.tr_no  order by a.tr_no desc limit 10";
                                        ...
                                        if(mysql_num_rows($data2)>0){
                                            while($dataa=mysql_fetch_row($data2)){ ?>
                                                ...
                                                <tr class="alt">
                                                    <td><?=$is=$is+1;?></td>
                                                    <td style="text-align: left;cursor: pointer" onclick="OpenPopupCenter('voucher_view_popup_ismail.php?<?php echo 'v_type=Contra&vdate='.$dataa[3].'&v_no='.$dataa[2].'&view=Show&in=Contra' ?>', 'TEST!?', 900, 600);"><?=$dataa[3]?></td>
                                                    <td><a href="voucher_print1.php?v_type=Contra&vo_no=<?php echo $dataa[2];?>" target="_blank"><?=$dataa[0]?></a></td>
                                ...
                                if($_SESSION[initiate_contra_note]){

                                ?>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            <div class="x_content">
                        <form action="" name="addem" id="addem" class="form-horizontal form-label-left" method="post" style="font-size: 11px">
                                    <table style="width:100%">
                                        <tbody>
                                            <tr>
                                            <td align="left" style="width: 20%">
                                                <select class="select2_single form-control" style="width:300px" tabindex="-1" required="required"  name="ledger_id">
                                                    <option></option>
                                                    <?php
                                                ...
                                                <td align="left" style="width: 10%">
                                                    <select class="select2_single form-control" style="width:120px" tabindex="-1"   name="cc_code">
                                                        <option></option>
                                                        <?php
                                ...
                                if($_GET[type]=='delete'){
                                    if($_GET[productdeletecode]){
                                        ...
                                        $results=mysql_query("Delete from coutra_no where id='$_GET[productdeletecode]'"); ?>
                                        <meta http-equiv="refresh" content="0;contra_note.php">
 ...
 ");
                                        while($uncheckrow=mysql_fetch_array($rs)){
                                            ...
                                            if (isset($_POST['confirmsave'])){
                                                ...
                                                add_to_journal_new($uncheckrow[coutradate],$proj_id, $jv, $date, $uncheckrow[ledger_id], $uncheckrow[narration], $uncheckrow[dr_amt], $uncheckrow[cr_amt],Contra, $uncheckrow[coutra_no],$uncheckrow[jid],$uncheckrow[cc_code],$uncheckrow[sub_ledger_id],$_SESSION[usergroup],$c_no,$c_date,$create_date,$ip,$now,$day,$thisday,$thismonth,$thisyear);
                                                 mysql_query("UPDATE coutra SET entry_status='' WHERE coutra_no='".$_SESSION['initiate_contra_note']."'");
                                                 unset($_SESSION['initiate_contra_note']); ?> <meta http-equiv="refresh" content="0;contra_note.php"> <?php }
                                            ...
                                            {
                                                mysql_query("DELETE FROM coutra WHERE id='$ids'"); ?>
                                                <meta http-equiv="refresh" content="0;contra_note.php">
                                                <?php }


                                            if(isset($_POST['editdata'.$ids]))
                                            { update_contra_add_data($ledger_code_update,$cc_code_update,$updr_amt,$upcr_amt,$upnarration,$ids);
                                                ?>
                                                <meta http-equiv="refresh" content="0;contra_note.php">
                                            <?php }?>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="width:10%;vertical-align:middle">
                                                    <button type="submit" name="editdata<?php echo $ids; ?>" style="background-color:transparent; border:none; font-size: 11px" onclick='return window.confirm("Mr. <?php echo $_SESSION["username"]; ?>, Are you sure you want to Edit Date?");'><img src="update.jpg" style="width:20px;  height:20px"></button>
                                                    <button type="submit" name="deletedata<?php echo $ids; ?>" style="background-color:transparent; border:none; font-size: 11px" onclick='return window.confirm("Mr. <?php echo $_SESSION["username"]; ?>, Are you sure you want to Delete Journal Voucher?");'><img src="delete.png" style="width:20px;  height:20px"></button>
                                                </td>
                                    ...
                                    $cancel=$_POST[cancel];
                                    if(isset($cancel)){
                                        $deletes=mysql_query("Delete From journal_voucher_master where voucherno='$_SESSION[initiate_contra_note]' and section_id='$_SESSION[sectionid]' and company_id='$_SESSION[companyid]'");
                                        $deletes=mysql_query("Delete From coutra where coutra_no='$_SESSION[initiate_contra_note]' and section_id='$_SESSION[sectionid]' and company_id='$_SESSION[companyid]'");
                                    ...
                                    <?php } else { ?>
                                        <font  style="font-size: 15px; color: red; font-weight: bold; float: right">Invalid Contra Journal!!</font>
                                    <?php } ?>
                                </form></div></div></div>
        <?php } ?>
