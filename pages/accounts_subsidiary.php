...
function reload(form)
{
	...
	self.location='accounts_subsidiary.php?rlid=' + val ;
}
...
function reload2(form)
{
	...
	self.location='accounts_subsidiary.php?rlid=' + val +'&mgid='+ val2  ;
}
...
$valid = true;
$flag=mysql_query("Select subsidiary from accounts_subsidiary where subsidiary='$subsidiary' and companyid='$_SESSION[companyid]'");
	if ( mysql_num_rows($flag)>0)
{echo "<script> alert('This Sub Group is Already Input!! Please Try Another Name') </script>";
        $valid = false;}
...
$result=mysql_query("INSERT INTO `accounts_subsidiary` 
(accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,companyid,createby,createdate,ip,mac) VALUES('$reporttype','$rlid','$reportlevelname','$_GET[mgid]','$maingroup','$_SESSION[sub_id]','$subsidiary','$companyid','$inputby','$create_date','$ip','$mac')");

	subsidiaryid(); ?>
    <meta http-equiv="refresh" content="0;accounts_subsidiary.php"><?php }}  ?>
...
?>
<meta http-equiv="refresh" content="0;accounts_subsidiary.php">
<?php } 
...
?>       
               ...
               <?php if($_GET[mgid]){ ?>
               <div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" >Sub Group<span class="required">*</span></label>
                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                   <thead>
                    <tr>
                     ...
                     <th style="">Sub Group</th>
                     <th style="width: 15%">Main Group</th>
...
<a href="accounts_subsidiary.php?type=edit&rleditid=<?php echo $row[rlid] ?>&mgroupeditid=<?php echo $row[mgid] ?>&subsidiaryeditid=<?php echo $row[subsidiaryid] ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Edit </a>



<a href="accounts_subsidiary.php?type=delete&rleditdeleteid=<?php echo $row[rlid] ?>&&mgroupdeleteid=<?php echo $row[mgid] ?>&subsidiarydeleteid=<?php echo $row[subsidiaryid] ?>"class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>                           
