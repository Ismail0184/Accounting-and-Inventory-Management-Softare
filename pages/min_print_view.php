...
$MAN_QUERY=find_all_field('MAN_master','','MAN_ID="'.$_GET[MAN_ID].'"');
?>
                ...
                <tr>
                  ...
                  <td width="40%" valign="top">
                      ...
                      <tr>
                        ...
                        <td  align="left" valign="middle" style="width:2%">: </td>
                        <td><?=$MAN_QUERY->delivary_challan;?></td>
                      </tr>
        ...
        <tr>
          <td colspan="2" align="center">
             ...
             <table style="font-size:11px; margin-top:50px" width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" style="text-decoration:overline"><strong>Indented By</strong></td>
                <td align="center" style="text-decoration:overline"><strong>Checked By </strong></td>
                <td align="center" style="text-decoration:overline"><strong>Issued By </strong></td>
