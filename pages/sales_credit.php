...
<html lang="en">
  ...
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Credit Sales</title>
...

{
	...
	self.location='sales_credit.php?ledgercode=' + val ;
                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                     ...
                     <div class="input-group pull-right">
								...
								<a class="btn btn-sm btn-default"  href="sales_challan_list.php">

									<i class="fa fa-plus-circle"></i> <span class="language" style="color:#000">Sales Challan List</span>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select class="select2_single form-control" style="width:100%" tabindex="-1" onchange="javascript:reload(this.form)"  required="required" name="vendor" > 
							...
							$result=mysql_query("Select * from accounts_ledger where companyid='$_SESSION[companyid]' and subsidiary='Accounts Receivable' order by ledger");
			  ...
			  ?>
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select class="select2_single form-control" style="width:100%" tabindex="-1"  name="subledger" >
...
<?php }}}
				 ...
				 ?>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row[model]; ?> - <?php echo $row[product]; ?></td>
...
if ($valid){
 ...
 ('$mcrow[accountreporttype]','$mcrow[rlid]','$mcrow[reportlevelname]','$mcrow[mgid]','$mcrow[maingroup]','$mcrow[subsidiaryid]','$mcrow[subsidiary]','$mcrow[ledgercode]','$mcrow[ledger]','$billno','$createdate','','','$amounts','$amounts','','Sales to  $supplier','1','','','','$companyid','','$createby','$ip','$mac','$createdate','$ttime','Cash Sales','$invoice','Normal','$day')");
...
<?php 	}      ?>                
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" name="getstarted" class="btn btn-success">Credit Sales </button>
