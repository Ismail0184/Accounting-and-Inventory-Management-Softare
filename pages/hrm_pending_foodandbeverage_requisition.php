...
$title="Pending Food & Beverage Requisition";
$dfrom=date('Y-1-1');
$dto=date('Y-m-d');
...
$page="hrm_pending_foodandbeverage_requisition.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
            ...
            <div class="x_content">
                <table class="table table-striped table-bordered" style="width:100%;font-size:12px">
				 ...
				 (SELECT concat(p2.PBI_NAME," # ","(",de.DESG_SHORT_NAME,")") FROM 
				  ...
				  from '.$table.' r
				  WHERE  req_category in ("1500010000") and 
				  hrm_viewed="NO"				  
				  ...
				  td.'.$unique.'='.$_GET[$unique].'');
                        while($req_data=mysql_fetch_object($res)){
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="recemmended_qty_<?=$req_data->id;?>" id="recemmended_qty_<?=$req_data->id;?>" value="<?=$req_data->recommend_qty;?>" style="width:80px" /></td>
                    ...
                    <?php if($current_status!=$required_status){ echo '<h5 style="text-align:center; color:red; font-weight:bold"><i>This requisition has not yet been approved ! Please wait until approval !!</i></h5>';} else { ?>
                        <table style="width:100%;font-size:12px">
                            ...
                            <tr>
                                ...
                                <td><div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <button type="submit" onclick='return window.confirm("Are you confirm the Requisition?");' name="authorised" id="authorised" class="btn btn-success">Confirmed and Issue to User</button>
                                        </div></div></td></tr></table>
                    <?php } ?>
