...
$item_details[] = $info->specification;
...
<? for($i=0;$i<$pi;$i++){?>     
      ...
      <tr>
        ...
        <td align="left" valign="top"><?=$asset_code[$i]?></td>
        <td align="left" valign="top"><strong><?=$item_name[$i]?> # </strong><?=$item_details[$i]?> 
        </td>
...
%)</strong></td>
 ...
 <?php } ?>
  ...
  <tr>
    ...
    <td align="right" valign="top"><strong>
      <?=number_format(($t_amount+$with_tax+$labor_bill+$others_bill+$transport_bill+$with_asf+$with_taxait),2)?>
    </strong></td></tr>
