...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Cash Purchase</title>
...
function reload(form)
{
 ...
 ?>
                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                     <div class="input-group pull-right">
							<a class="btn btn-sm btn-default"  href="purchase_cash_barcode.php">
									<i class="fa fa-plus-circle"></i> <span class="language" style="color:#000">Purchase with Barcode</span>
								</a>
                                
                                <a class="btn btn-sm btn-default"  href="purchase_credit.php">
									<i class="fa fa-plus-circle"></i> <span class="language" style="color:#000">Credit Purchase</span>
								</a>
                                ...
                                <a class="btn btn-sm btn-default" style="color:#000" href="stock_report.php">
                    				<i class="fa fa-plus-circle"></i> <span class="language" style="color:#000">Stock Balance</span>
                    			</a>


                    			               
                    			<a class="btn btn-sm btn-default" style="color:#000" href="sales_cash.php">
	            ...
	            <input type="text" id="last-name"  required="required" name="purchasedate" value="<?php echo date('Y-m-d'); ?>" class="form-control col-md-7 col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name"  readonly  required="required" name="billno" value="<?php echo $_SESSION['ceshexpenses']; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <!--div class="form-group">
                        ...
                        <input type="text" id="first-name" required="required" value="" name="supplier" class="form-control col-md-7 col-xs-12"></div></div--->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<?php if($_GET[type]){ ?>
                        <input type="text" id="first-name" required="required"  name="supplier" class="form-control col-md-7 col-xs-12" readonly><?php } else { ?>
                 ...
                 <option value="<?php echo $rowmaingroup[warehousename]; ?>"><?php echo $rowmaingroup[warehousename]; ?></option>
                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php 
				$results=mysql_query("Select * from inventory_product where  companyid='$_SESSION[companyid]' order by productcode");
	...
	$mcresults=mysql_query("Select * from accounts_ledger where ledgercode='$supplier' and companyid='$_SESSION[companyid]'");
$mcrows=mysql_fetch_array($mcresults);
				 ...
				 ?>
                      <tr>
                        ...
                        <td><?php echo $row[product]; ?></td>
                         ...
                         <td style="width:8%"><?php echo $row[model]; ?></td>
                        <td style="width:8%"><?php echo $row[brand]; ?></td>
                     ...
                     <td align="center"><input type="text" id="last-name"  style="width:80px" name="rate<?php echo $ids; ?>" value="<?php echo $row[rate] ?>" class="form-control col-md-7 col-xs-12"></td>
                      ...
                      <td align="center">
                     <select name="warranty<?php echo $ids; ?>" style="height:30px" >
...
$supresult=mysql_query("Select * from accounts_ledger where ledgercode='$supplier' and companyid='$_SESSION[companyid]'");
...
if ($valid){
 ...
 ('$prow[accountreporttype]','$prow[rlid]','$prow[reportlevelname]','$prow[mgid]','$prow[maingroup]','$prow[subsidiaryid]','$prow[subsidiary]','$prow[ledgercode]','Purchase','$billno','$purchasedate','','','$amounts','$amounts','','Main Cash, Purchase from  $suprow[ledger]','1','','','','$companyid','','$createby','$ip','$mac','$createdate','$ttime','Cash Purchase','$invoice','Normal','$day')");		
 
 
 
 
 $result=mysql_query("INSERT INTO `transaction_cash` (accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,ledgercode,ledger,	VNumber,TDate,qty,rate,Amount,debitamount,creditamount,Note,SubID,journal,Person,CheckNumber,companyid,company,Username,IPAdress,	MAC,IDate,time,ttype,invoiceno,status,day) VALUES 
 ('$mcrow[accountreporttype]','$mcrow[rlid]','$mcrow[reportlevelname]','$mcrow[mgid]','$mcrow[maingroup]','$mcrow[subsidiaryid]','$mcrow[subsidiary]','$mcrow[ledgercode]','Main Cash','$billno','$purchasedate','','','-$amounts','','$amounts','Purchase from  $suprow[ledger]','0','','','','$companyid','','$createby','$ip','$mac','$createdate','$ttime','Cash Purchase','$invoice','Normal','$day')");
 ceshexpensesid(); ?>
<meta http-equiv="refresh" content="0;purchase_report.php">
	<?php }}      ?>                
                  <div class="form-group">
