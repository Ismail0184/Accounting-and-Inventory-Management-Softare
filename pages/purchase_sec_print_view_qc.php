...
$prold = find_all_field('purchase_receive','pr_no','id='.$jvold);
	...
	$sssql = 'delete from journal where group_for="'.$_SESSION['user']['group'].'" and tr_from ="Purchase" and tr_no="'.$prold->pr_no.'"';
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td width="0"><?=date('Y-m-d',$jv->jv_date);?></td>
...
<a target="_blank" href="chalan_view2.php?v_no=<?=$pr->pr_no?>"></a></div><? }else{?>
...
<a target="_blank" href="chalan_view2.php?v_no=<?=$pr->pr_no?>"></a></div><? }?>
...
$sql2="SELECT a.ledger_id,a.ledger_name,sum(dr_amt) as dr_amt FROM accounts_ledger a, secondary_journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id and jv_no=$jv_no and dr_amt>0 group by b.ledger_id desc";
...
$sql2="SELECT a.ledger_id,a.ledger_name,sum(cr_amt) as cr_amt FROM accounts_ledger a, secondary_journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id and jv_no=$jv_no and cr_amt>0 group by b.ledger_id desc";
