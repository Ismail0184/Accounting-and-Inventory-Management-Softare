...
where b.item_id=i.item_id and b.warehouse_id=w.warehouse_id and b.warehouse_id="'.$_POST['warehouse_id'].'" order by b.id desc';
$_SESSION[batch_warehouse_id] = $_POST['warehouse_id'];
}
