...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><input name="unit_price" type="hidden" class="input3" id="unit_price"  style="width:55px;" value="<?=$item_all->d_price?>"/>
      <input name="unit_price2" type="text" class="input3" id="unit_price2"  style="width:55px;" value="<?=($item_all->d_price)?>"/>
