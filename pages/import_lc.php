...
(company_id,company_name,company_type,contact_person,contact_number,email_id,address,create_by,create_date) VALUES 
               ...
               <div class="x_content">
                    ...
                    <form id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Clint Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" value="<?php echo $row[name] ?>" name="company_name" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Business Type <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name"  required="required" name="email_id" value="<?php echo $row[business_type] ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <button type="submit" name="edit" class="btn btn-success">Edit Clint</button>
                        <?php } else { ?>
                          <button type="cancel" class="btn btn-primary">Cancel</button>
                          <button type="submit" name="getstarted" class="btn btn-success">Create Clint</button>
