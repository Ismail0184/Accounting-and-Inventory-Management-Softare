...
$page="emp_access_requisition_vehicle_application.php";
$crud      =new crud($table);
                                     ...
                                     <table style="width:100%"  cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <div class="form-group" style="width: 100%">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="date"  readonly  required="required" name="application_date" value="<?=($application_date!='')? $application_date : date('Y-m-d') ?>" min="<?=date('Y-m-d')?>" class="form-control col-md-7 col-xs-12" style="width:100%" >      </div>
                                                </div>
                                            </td></tr>
...
<tr><td style="height:3px"></td></tr>                                            
             ...
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width:40%">Travel Date From<span class="required">*</span></label>
	            ...
	            <input type="date"   required="required" name="trvDate_from" value="<?=($trvDate_from!='')? $trvDate_from : date('Y-m-d') ?>" min="<?=date('Y-m-d')?>" class="form-control col-md-7 col-xs-12" >
                                        </div></div> 
                                        </td>
  ...
  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width:40%">To<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
       <input type="date"  style="width:100%" value="<?=($trvDate_to!='')? $trvDate_to : date('Y-m-d') ?>" required   name="trvDate_to" min="<?=date('Y-m-d')?>" class="form-control col-md-7 col-xs-12" >
                                    </div></div>
                                    </td>
                                    </tr>
               ...
               <? $sql_recommended_by="SELECT  p.PBI_ID,concat(p.PBI_ID_UNIQUE,' : ',p.PBI_NAME,' : ',d.DEPT_SHORT_NAME) FROM 
							...
							department d
							 ...
							 p.PBI_DEPARTMENT=d.DEPT_ID					 
							  order by p.PBI_NAME";
               advance_foreign_relation($sql_recommended_by,$approved_by);?></select>
                                        </div></div> 
                                        </td>
                        ...
                        <form action="" enctype="multipart/form-data" name="addem" id="addem" class="form-horizontal form-label-left" method="post" style="font-size: 11px">
                            ...
                            <table align="center" class="table table-striped table-bordered" style="width:98%; font-size: 11px">
                                        ...
                                        <tr style="background-color: bisque">
                                            ...
                                            <th style="text-align:center; vertical-align: middle;">Current Location</th>
                                            <th style="text-align:center; vertical-align: middle; ">Place From</th>
                                            <th style="text-align:center; vertical-align: middle; ">Place To</th>
                                            <th style="text-align:center">for hours</th>
                                        ...
                                        <tr>
<td>
<input type="hidden" id="trvClaim_id" style="width:200px" name="trvClaim_id" value="<?=$trvClaim_id?>" min="<?=date('Y-m-d')?>"  class="form-control col-md-7 col-xs-12" >
<input type="date" required="required" name="travel_date"  class="form-control col-md-7 col-xs-12" >
</td>

<td>
<input type="text" id="current_location"   required="required" name="current_location" placeholder="Current Location" class="form-control col-md-7 col-xs-12" >
</td>

<td>
<input type="text" id="travel_from"   required="required" name="travel_from" placeholder="Place from" class="form-control col-md-7 col-xs-12" >
</td>


<td>
<input type="text" id="travel_to"    required="required" name="travel_to" placeholder="Place to"  class="form-control col-md-7 col-xs-12" >
</td>

<td>
<input type="text" id="time_for"  required="required" name="time_for" placeholder="for hours"  class="form-control col-md-7 col-xs-12" >
</td>

<td align="center" style="width:5%"><button type="submit" class="btn btn-primary" name="add" style="font-size: 11px" id="add">Add</button></td></tr>
                                            </tbody>
                                    </table>
                                </form>
 ...
 ");
                        while($uncheckrow=mysql_fetch_array($rs)){
                            ...
                            <tr>
                                ...
                                <input type="date"  style="width:200px;height:30px; font-weight:bold; text-align:center; float:none" name="travel_date_upd<?php echo $ids; ?>"  value="<?=$uncheckrow[travel_date];?>" class="form-control col-md-7 col-xs-12" >
                                </td>
