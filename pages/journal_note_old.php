                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="x_panel">
                         ...
                         <?php
                                ...
                                $journal_info_noMAX=next_invoice('journal_info_no','journal_info');
                                ...
                                if(isset($initiate)){
                                    add_to_journal_master($invoice,$transaction_date, $_POST[r_from], $_POST[c_no], $c_date, $_POST[bank], MANUAL, $_POST[remarks],Journal_info,$_POST[PBI_ID],$ip);
                                    $_SESSION[initiate_journal_note]=$invoice;}
                                ...
                                if(isset($_POST[updateMAN])){
                                    journal_master_update($transaction_date,$_POST[r_from], $_POST[c_no], $c_date,$_POST[bank],$_POST[remarks],$_POST[PBI_ID],$_SESSION[initiate_journal_note]); ?>
                                    <meta http-equiv="refresh" content="0;journal_note.php">

                                <?php  }

                                $resultsssss=mysql_query("Select * from journal_voucher_master where voucherno='$_SESSION[initiate_journal_note]'");
                              ...
                              <form action="" enctype="multipart/form-data" method="post" name="addem" id="addem" style="font-size: 11px">
                                    <table align="center" style="width:100%">
                                        <tr>
                                            <td style="width:50%;">
                                                <div class="form-group" style="width: 100%">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="nam_date"  required="required" name="nam_date" value="<?php if($_SESSION[initiate_journal_note]){ echo date('m/d/y' , strtotime($inirow[voucher_date])); } else { echo ''; } ?>" class="form-control col-md-7 col-xs-12" style="width: 130px; font-size: 11px" ><br>
                                                    </div>
                                                </div></td>
                                            ...
                                            <td style="width:50%"><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="last-name"   required="required" name="invoice" value="<?php if($_SESSION[initiate_journal_note]){ echo $inirow[voucherno];} else { echo $_SESSION['JVNONEW']; } ?>" class="form-control col-md-7 col-xs-12"  readonly style="width: 130px;font-size: 11px">
                                                    </div>
                                                </div>
                                            </td></tr>
                                   ...
                                   <tr>
                                            <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="r_from"  value="<?php if($_SESSION[initiate_journal_note]){ echo $inirow[paid_to];} else { echo ''; } ?>" name="r_from" class="form-control col-md-7 col-xs-12" required style="width: 130px;font-size: 11px; margin-top: 5px" >
                                                    </div></div></td>
                                        ...
                                        <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="PBI_ID"  value="<?php if($_SESSION[initiate_journal_note]){ echo $inirow[PBI_ID];} else { echo ''; } ?>" name="PBI_ID" class="form-control col-md-7 col-xs-12"  style="width: 130px; margin-top: 5px; font-size: 11px">
                                                    </div></div></td></tr>
                                        ...
                                        <tr> <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="c_no"  value="<?php if($_SESSION[initiate_journal_note]){ echo $inirow[Cheque_No];} else { echo ''; } ?>" name="c_no"  class="form-control col-md-7 col-xs-12" style="width: 130px; margin-top: 5px; font-size: 11px" ></div></div></td>
                                            ...
                                            <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="c_date"   value="<?php if($_SESSION[initiate_journal_note]){ echo date('m/d/y' , strtotime($inirow[Cheque_Date]));} else { echo ''; } ?>" name="c_date"  class="form-control col-md-7 col-xs-12"  style="width: 130px; margin-top: 5px; font-size: 11px">
                                                    </div></div></td></tr>
                                    ...
                                    <div class="form-group" style="margin-left:40%; margin-top: 15px">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <?php if($_SESSION[initiate_journal_note]){  ?>
                                                ...
                                                <button type="submit" name="updateMAN" class="btn btn-primary" onclick='return window.confirm("Are you confirm to Update?");'>Update Journal Voucher</button>
                                            <?php   } else {?>
                                                <button type="submit" name="initiate" class="btn btn-primary">Initiate Journal Voucher</button>
                                            <?php } ?>
                                        </div></div>
                                </form></div></div></div>
...
from  journal a where a.tr_from='journal_info' and a.user_id='$_SESSION[userid]'  group by a.tr_no  order by a.tr_no desc limit 10";
                                        $data2=mysql_query($sql2);
                                        if(mysql_num_rows($data2)>0){
                                            while($dataa=mysql_fetch_row($data2)){ ?>
                                                <tr class="alt">
                                                    <td><?=$is=$is+1;?></td>
                                                    <td style="text-align: left;cursor: pointer" onclick="OpenPopupCenter('voucher_view_popup_ismail.php?<?php echo 'v_type=journal_info&vdate='.$dataa[3].'&v_no='.$dataa[2].'&view=Show&in=journal_info' ?>', 'TEST!?', 900, 600);"><?=$dataa[3]?></td>
                                                    <td><a href="voucher_print1.php?v_type=journal_info&vo_no=<?php echo $dataa[2];?>" target="_blank"><?=$dataa[0]?></a></td>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <form action="" name="addem" id="addem" class="form-horizontal form-label-left" style="font-size: 11px" method="post">
                                    <table style="width:100%">
                                        <tbody>
                                            <tr>
                                            <td align="left" style="width: 20%">
                                                <select class="select2_single form-control" style="width:280px" tabindex="-1" required="required"  name="ledger_id">
                                                    <option></option>
                                                    <?php
                                                ...
                                                <td align="left" style="width: 12%">
                                                    ...
                                                    <select class="select2_single form-control" style="width:150px" tabindex="-1"   name="cc_code">
                                          ...
                                          <td style="width:15%" align="center">
                                                <input type="text" id="narration" style="width:200px; height:37px; font-size: 12px; text-align:center"    name="narration" placeholder="Narration"  class="form-control col-md-7 col-xs-12" autocomplete="off" ></td>
                                ...
                                if($_GET[type]=='delete'){
                                    ...
                                    if($_GET[productdeletecode]){
                                        ...
                                        $results=mysql_query("Delete from journal_info where id='$_GET[productdeletecode]'"); ?>
...
a.*,c.center_name as cname from journal_info j,
 ...
 ");
                                        ...
                                        while($uncheckrow=mysql_fetch_array($rs)){
                                            ...
                                            if (isset($_POST['confirmsave'])){
                                                add_to_journal_new($uncheckrow[j_date],$proj_id, $jv, $date, $uncheckrow[ledger_id], $uncheckrow[narration], $uncheckrow[dr_amt], $uncheckrow[cr_amt],Journal_info, $uncheckrow[journal_info_no],$uncheckrow[jid],$uncheckrow[cc_code],$uncheckrow[sub_ledger_id],$_SESSION[usergroup],$c_no,$c_date,$create_date,$ip,$now,$day,$thisday,$thismonth,$thisyear);
                                               mysql_query("UPDATE journal_info SET entry_status='' WHERE journal_info_no='".$_SESSION['initiate_journal_note']."'");
                                        ...
                                        <?php }
                                            ...
                                            if(isset($_POST['deletedata'.$ids])){
                                                mysql_query("DELETE FROM journal_info WHERE id='$ids'"); ?>
                                                <meta http-equiv="refresh" content="0;journal_note.php">

                                                <?php  }
                                            if(isset($_POST['editdata'.$ids])){

                                                update_journal_info_add_data($ledger_code_update,$cc_code_update,$updr_amt,$upcr_amt,$upnarration,$ids); ?>
                                                <meta http-equiv="refresh" content="0;journal_note.php">
                                            ...
                                            <tr>
                                                <td style="width:3%; vertical-align:middle"><?php echo $j; ?></td>
                                                <td style="vertical-align:middle"><select class="select2_single form-control" style="width:300px" tabindex="-1" required="required" id="ledger_code_update<?php echo $ids; ?>"   name="ledger_code_update<?php echo $ids; ?>">
                                                ...
                                                <td style="vertical-align:middle"><select class="select2_single form-control" style="width:120px" tabindex="-1"  id="cc_code_update<?php echo $ids; ?>"  name="cc_code_update<?php echo $ids; ?>" ">
                                                ...
                                                <td align="center" style="width:6%; text-align:center">
                                                    <input type="text" id="updr_amt<?php echo $ids; ?>" style="width:110px; margin-left:1%; height:37px; font-size: 11px; font-weight:bold; text-align:center; float:none"    name="updr_amt<?php echo $ids; ?>"  value="<?=$uncheckrow[dr_amt] ;?>" class="form-control col-md-7 col-xs-12" autocomplete="off" <? if($uncheckrow[dr_amt]==0) echo  'readonly';?> >
                                                </td>

                                                <td align="center" style="width:6%; text-align:center">
                                                    <input type="text" id="upcr_amt<?php echo $ids; ?>" style="width:90px; margin-left:1%; height:37px; font-weight:bold; text-align:center; float:none; font-size: 11px;"    name="upcr_amt<?php echo $ids; ?>"  value="<?=$uncheckrow[cr_amt] ;?>" class="form-control col-md-7 col-xs-12" autocomplete="off" <? if($uncheckrow[cr_amt]==0) echo  'readonly';?> >
                                                </td>
                                        ...
                                        <tr> <td colspan="4" style="font-weight:bold;" align="right">Total</td>
                                    ...
                                    $cancel=$_POST[cancel];
                                    if(isset($cancel)){
                                        $deletes=mysql_query("Delete From journal_voucher_master where voucherno='$_SESSION[initiate_journal_note]' and section_id='$_SESSION[sectionid]' and company_id='$_SESSION[companyid]'");
                                        $deletes=mysql_query("Delete From journal_info where journal_info_no='$_SESSION[initiate_journal_note]' and section_id='$_SESSION[sectionid]' and company_id='$_SESSION[companyid]'");
                                        unset($_SESSION["initiate_journal_note"]); ?>
                                        <meta http-equiv="refresh" content="0;journal_note.php">
                                    <?php } ?>
                                    ...
                                    <?php } else { ?>
                                        <font  style="font-size: 15px; color: red; font-weight: bold; float: right">Invalid Journal Voucher!!</font>
                                    <?php } ?>
                                </form>
                                    </div></div></div>
