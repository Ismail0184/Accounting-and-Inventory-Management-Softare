...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Create Groups</title>
...
if (isset($_POST['getstarted'])){
	...
	$flag=mysql_query("Select groups from inventory_groups where groups='$groups'");
	if ( mysql_num_rows($flag)>0)

    {echo "<script> alert('This Groups Name Already Input!! Please Try Another Brand') </script>";
        $valid = false;} 
	 
	 
if ($valid){
$result=mysql_query("INSERT INTO `inventory_groups` (inventory_types,groups,createby,createdate,companyid) VALUES ('Finish Goods','$groups','$createby','$createdate','$companyid')"); ?>
...
$delete=$_POST[delete];	
$deleteid=$_GET[groupsiddelete];
if($_GET[groupsiddelete]){
$result=mysql_query("Delete from inventory_groups where id='$deleteid'");	?>
	
	<meta http-equiv="refresh" content="0;inventory_groups.php">	
<?php } ?> 

 <?php 
$result=mysql_query("Select * from inventory_groups where id='$_GET[groupsid]'");
...
?>                
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel"> 
                <div class="x_title">
                    <h2>Create Inventory Groups <small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                     <div class="input-group pull-right">
								<a class="btn btn-sm btn-default" href="inventory_groups.php">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
				$result=mysql_query("Select * from inventory_groups order by id");
      ...
      <a href="inventory_groups.php?type=edit&groupsid=<?php echo $row[id] ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Edit </a>
      <a href="inventory_groups.php?groupsiddelete=<?php echo $row[id] ?>" class="btn btn-danger btn-xs"><i class="fa fa-pencil"></i> Delete </a>
