...
function reload(form)
{
	...
	self.location='inventory_categorys.php?inventorytype=' + val ;
}
...
function reload2(form)
{
	...
	self.location='inventory_categorys.php?inventorytype=' + val +'&categoryid=' + val2 ;
}
...
$flag=mysql_query("Select groups from inventory_brand where brand='$brand' and companyid='$_SESSION[companyid]'");
...
if ($valid){
 $result=mysql_query("INSERT INTO `inventory_brand` (inventory_types,categoryid,category,brand,createby,createdate,companyid) VALUES ('$_GET[inventorytype]','$_GET[categoryid]','$category','$brand','$createby','$createdate','$companyid')"); ?>
...
mysql_query("Update inventory_brand SET 

brand='$brand',
modifiddate='$createdate', 
modifidby='$createby' 

 where id='$_GET[brandeditid]' and companyid='$_SESSION[companyid]'");
?>
<meta http-equiv="refresh" content="0;inventory_categorys.php">
<?php } ?>               
...
$delete=$_GET[branddeleteid];	

if(isset($delete)){
$result=mysql_query("Delete from inventory_brand where id='$_GET[branddeleteid]'  and companyid='$_SESSION[companyid]'");	?>
	
	<meta http-equiv="refresh" content="0;inventory_categorys.php">	
<?php } ?> 

 <?php 
$result=mysql_query("Select * from inventory_brand where id='$_GET[brandeditid]' and companyid='$_SESSION[companyid]'");
                  ...
                  <option value="<?php echo $row[inventory_type]; ?>"><?php echo $row[inventory_type]; ?></option>
                    <?php }} ?>
                     ...
                     <div class="form-group">
                       ...
                       <input type="text" id="first-name" readonly required="required"  value="<?php echo $row[category] ?>" name="category" class="form-control col-md-7 col-xs-12">
                  ...
                  <option value="<?php echo $row[id]; ?>"><?php echo $row[category]; ?></option>
                    <?php }} ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name"  required="required" name="brand" value="<?php echo $row[brand] ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <a type="cancel" href="inventory_categorys.php" class="btn btn-primary">Cancel</a>
                        <button type="submit" name="edit" class="btn btn-success">Edit Brand</button>
                        <?php } else { ?>
                          
                          <a type="cancel" href="inventory_categorys.php" class="btn btn-primary">Cancel</a>
                          <button type="submit" name="getstarted" class="btn btn-success">Create Brand</button>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
				$results=mysql_query("Select * from inventory_brand order by id");
                      ...
                      <tr>
                        ...
                        <td><?php echo $row[inventory_types]; ?></td>
                          ...
                          <td align="center">
                            ...
                            <a href="inventory_categorys.php?type=edit&categoryeditit=<?php echo $row[categoryid] ?>&brandeditid=<?php echo $row[id] ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                           
                            <a href="inventory_categorys.php?type=delete&categorydeleteid=<?php echo $row[categoryid] ?>&branddeleteid=<?php echo $row[id] ?>" class="btn btn-danger btn-xs"><i class="fa fa-pencil"></i> Delete </a>
