...
$title='Demand Order Create (Export)';
...
auto_complete_from_db('item_info','concat(finish_goods_code,"#>",item_name)','finish_goods_code','product_nature="Salable" and exim_status in ("Export")','item');
...
<div class="form-container_large">
    ...
    <form action="<?=$page?>" method="post" class="form-horizontal form-label-left" name="codz2" id="codz2">

        <?require_once 'support_html.php';?>

        <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-size: 11px; font-weight: normal">
                    ...
                    <fieldset style="width:200px;">
                        <div class="form-group" style="width: 100%">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input style="width:155px;"  name="exim_status" type="hidden" id="exim_status" value="Export" class="form-control col-md-7 col-xs-12" readonly/>
                        ...
                        <div class="form-group" style="width: 100%">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="select2_single form-control" style="width:157px; height:35px; font-size: 11px" id="dealer_code" name="dealer_code" readonly="readonly">
                        ...
                        <div class="form-group" style="width: 100%">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="remarks" id="remarks" value="<?=$remarks?>" style="width:155px;"  class="form-control col-md-7 col-xs-12" >
                ...
                <td><fieldset style="width:200px;">
                        ...
                        <div class="form-group" style="width: 100%">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select class="select2_single form-control" style="width:157px; height:35px; font-size: 11px" name="do_type" id="do_type"  required>
                        ...
                        <div class="form-group" style="width: 100%">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select class="select2_single form-control" style="width:157px; height:35px; font-size: 11px" id="depot_id" name="depot_id" required>
            ...
            <tr>
                ...
                <td align="center" colspan="4">
                    ...
                    if($$unique_master>0) {?>
                        ...
                        <button type="submit" name="new" class="btn btn-primary">Update Demand Order</button>

                        <input name="flag" id="flag" type="hidden" value="1" />

                    <? }else{?>

                        <button type="submit" name="new" class="btn btn-primary">Initiate Demand Order</button>
...
<? if($$unique_master>0){?>
        ...
        <input name="flag" id="flag" type="hidden" value="1" />
                  ...
                  <input name="unit_price" type="text" class="input3" id="unit_price"  style="width:55px;" value="<?=$item_all->d_price?>" placeholder="price" readonly/>
                    ...
                    <input name="pkt_size" type="hidden" class="input3" id="pkt_size"  style="width:55px;"  value="<?=$item_all->pack_size?>" readonly/>
                            ...
                            <td style="vertical-align: middle">
                                ...
                                <button  type="submit" class="btn btn-primary" name="add" onclick="count()" tabindex="5" id="add">Add</button></td>
                ...
                <table align="center"  class="table table-striped table-bordered" style="width:98%; font-size: 11px">
                    ...
                    <tr style="background-color: bisque">
                        ...
                        <th colspan="2" style="text-align:center; background-color:#0FF;vertical-align: middle">Order </th>
                ...
                <form action="select_dealer_do_export.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
                    ...
                    <table width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <button type="submit" name="delete"  class="btn btn-danger">Delete & Cancel this DO</button>
                            ...
                            <td align="right" style="text-align:right">
                                ...
                                <?php } else  { ?>
                                    ...
                                    <button type="submit" name="confirm"  class="btn btn-success" style="width:270px;  float:right" <?=($freeStock>0)? 'disabled' : ''?>>PRIMARILY SAVE THIS DO</button>
...
<footer>
    ...
    <div class="clearfix">Ã‚Â© <?=date('Y')?> <strong>RARESOFT</strong> All Rights Reserved</div>
