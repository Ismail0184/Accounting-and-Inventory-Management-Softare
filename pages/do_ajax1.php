...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
     <td><input name="inStock_ctn" type="text" class="input3" id="inStock_ctn"  style="width:45px;" value="<? $inStockCtn = ($in_stock_pcs-$ordered_qty)/$item_all->pack_size; $inStockCtn=(int)$inStockCtn; echo $inStockCtn;?>" readonly="readonly"/>

	<input name="inStock_pcs" type="text" class="input3" id="inStock_pcs"  style="width:45px;" value="<?=($in_stock_pcs-$ordered_qty)-($inStockCtn*$item_all->pack_size)?>" readonly="readonly"/>
	
      <input name="item_id" type="hidden" class="input3" id="item_id"  style="width:55px;"  value="<?=$item_all->item_id?>" readonly="readonly"/></td>
    <td><input name="unit_price" type="hidden" class="input3" id="unit_price"  style="width:40px;" value="<?=$item_all->d_price?>"/>
      <input name="unit_price2" type="text" class="input3" id="unit_price2"  style="width:40px;" value="<?=($item_all->d_price)?>"/>
