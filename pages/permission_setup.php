<?php
 ...
 $title='User Permission Main';
 
 if($_SESSION["department"]=='Developer' || $_SESSION["department"]=='MIS'){ 
?>
...
<div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                <div class="x_title">
                <h2><?php echo 'PARAMETERS LIST' ; ?></h2>
                <div class="clearfix"></div>
                </div>
                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%;">
                   <thead>
                    <tr>
                     <th style="width: 2%">#</th>
                     <th style="width:4%">PARAMETERS_CODE</th>
                     <th style="width:8%">PARAMETERS Name</th>
...
<?php
$resultss=mysql_query("Select * from PARAMETERS order by id DESC ");
...
?>
                      ...
                      <tr style="font-size:12px">
                        ...
                        <td><a href="<?php echo $link; ?>" target="_new"><?php echo $rows[PARAMETERS_CODE]; ?></a></td>
                        <td><?php echo $rows[PARAMETERS_Name]; ?></td>
...
<?php } else { echo '<h4 align="center" style="table-align:center">Sorry! You have no permission to view the page</h4>';} ?>