...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Sales Edit</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" id="last-name"   required="required" name="invoice" value="<?php echo $inirow[invoice_date]; ?>" class="form-control col-md-7 col-xs-12"  readonly >
