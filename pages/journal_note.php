...
<?php require_once 'body_content_entry_mod.php'; ?>
                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <tr>
                            ...
                            <td><input type="text" required="required" name="<?=$unique?>" id="<?=$unique?>"  value="<?=($_SESSION['initiate_journal_note']!='')? $_SESSION['initiate_journal_note'] : jn_vn() ?>" class="form-control col-md-7 col-xs-12" readonly style="width: 90%; font-size: 11px;"></td>
                        </tr>
