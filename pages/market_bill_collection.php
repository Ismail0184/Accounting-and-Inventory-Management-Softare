...
('$mcrow[accountreporttype]','$mcrow[rlid]','$mcrow[reportlevelname]','$mcrow[mgid]','$mcrow[maingroup]','$mcrow[subsidiaryid]','$mcrow[subsidiary]','$mcrow[ledgercode]','Main Cash','$subledgercode','$subledger','$VNumber','$tdates','$amount','$amount','','$note0','0','$companyid','$_SESSION[login_email]','$ip','$create_date','$timess','Cash Received','$invoiceno','$day','All','DR')");

// Party ledger start from here....

$cashtransaction=mysql_query("INSERT INTO transaction_cash (accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,ledgercode,ledger,subledgercode,subledger,VNumber,TDate,Amount,debitamount,creditamount,Note,SubID,companyid,Username,IPAdress,IDate,time,ttype,invoiceno,day,sectionname,journal) VALUES 
('$mcrow[accountreporttype]','$ledgerrow[rlid]','$ledgerrow[reportlevelname]','$ledgerrow[mgid]','$ledgerrow[maingroup]','$ledgerrow[subsidiaryid]','$ledgerrow[subsidiary]','$ledgerrow[ledgercode]','$ledgerrow[ledger]','$subledgercode','$subledger','$VNumber','$tdates','-$amount','','$amount','$note1','1','$companyid','$_SESSION[login_email]','$ip','$tdates','$timess','Cash Received','$invoiceno','$day','All','CR')");

echo "Data Successfully Saved $ledgerrow[ledger]";
				svoucherid(); ?>
                <meta http-equiv="refresh" content="0;market_bill_collection.php">
...
<?php } ?>                    
                    ...
                    <form class="form-horizontal form-label-left" method="post">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Market Ledger</label>
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id="first-name" required="required" style="width:100%" value="<?php echo $_SESSION['svoucher']; ?>" name="VNumber" class="form-control col-md-7 col-xs-12" readonly></div></div>
			 ...
			 $cashbalances=number_format($cashbalance,2);
			  ?>
               ...
               <input type="text" id="first-name" style="width:47%; margin-left:6%; font-weight:bold; color:#F00" value="Due Amount: <?php if($cashbalance>0) { echo $cashbalances; } else {echo "00";}  ?> ৳"  readonly name="balances" class="form-control col-md-7 col-xs-12"></div></div>
