...
$title="Un-Authorized FG Purchase Requisition List";
$dfrom=date('Y-1-1');
$dto=date('Y-m-d');
...
$page="hrm_unauthorised_requisition_fg_purchase.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
                   ...
                   <tr>
                      ...
                      <tr style="font-weight: bold">
                          <td colspan="5" style="text-align: right">Total Amount</td><td style="text-align: right"><?=number_format($total_amount,2)?></td><td></td>
                                ...
                                <?php
                                if(isset($_POST[recommend])){
								mysql_query("Update ".$table." SET status='".$Authorized_status."',authorised_date='$todayss' where ".$unique."=".$_GET[$unique]."");
...
mail($to,$subject,$txt,$headers); 
                       ...
                       echo "<script>window.close(); </script>";
								...
								?>
                                     ...
                                     <?php if($current_status==$Authorized_status){ echo '<h5 style="text-align:center; color:red; font-weight:bold"><i>This requisition has been recommended!!</i></h5>';} else { ?>
