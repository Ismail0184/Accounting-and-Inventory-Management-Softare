...
$page="emp_access_report_outdoor_duty.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
...
$res="select l.id as rid, a.PBI_NAME as name, l.attendance_date as Date,l.place, l.late_reason as Purpose,status,entry_at, (select PBI_NAME from personnel_basic_info where PBI_ID=l.authorised_by) as Approved_by,authorised_at as Approved_at from 
								personnel_basic_info a, ".$table." l where  a.PBI_ID=l.PBI_ID and  l.PBI_ID='".$_SESSION[PBI_ID]."' and l.attendance_date between '".$_POST[f_date]."' and '".$_POST[t_date]."'
...
<form  name="addem" id="addem" class="form-horizontal form-label-left" method="post" >
        <table align="center" style="width: 50%;">
            <tr><td>
                ...
                <td style="padding:10px"><button type="submit" style="font-size: 11px; height: 30px" name="viewreport"  class="btn btn-primary">View OD Attendance</button></td>
            </tr></table>
