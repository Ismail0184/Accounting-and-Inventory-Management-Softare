...
$now=time();
$unique='DEPT_ID';
$unique_field='DEPT_DESC';
$table="department";
$page="hrm_setup_department.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
                            ...
                            <div class="x_content">
                                ...
                                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 40%">Department Name<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 40%">Department Name (Short)<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="DEPT_SHORT_NAME" style="width:100%"  name="DEPT_SHORT_NAME" value="<?=$DEPT_SHORT_NAME;?>" class="form-control col-md-7 col-xs-12" >
                                        </div></div>
