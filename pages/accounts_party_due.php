...
<html lang="en">
  ...
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Challan List</title>
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				$result=mysql_query("Select * from accounts_ledger where subsidiary='Accounts Receivable' and companyid='$_SESSION[companyid]' order by 	ledger");
				...
				$dueamountss=getSVALUE("transaction_cash", "SUM(amount) as amount", " where ledgercode='$row[ledgercode]' and companyid='$_SESSION[companyid]'");
