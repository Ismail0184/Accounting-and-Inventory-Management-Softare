...
$page="acc_inventory_opening.php";
$crud      =new crud($table);
$$unique = $_POST[$unique];
...
$batch_get=find_all_field('item_info','','item_id="'.$_GET['item_id'].'"');
?>
...
<?php if($_SESSION['cc_unique']>0):?>
             ...
             <tr>
             <td colspan="5" style="vertical-align:middle" align="center"><input type="file" name="file" id="file"  /></td>
             ...
             <input type="hidden" name="cc_date"   value="<?=$cc_date;?>">
                   <tr>
                       ...
                       <td style="vertical-align:middle;width: 10%">
                           <input type="number" name="item_price" id="item_price" required="required" readonly class="form-control col-md-7 col-xs-12" style="width:96%; margin-left:2%; height:38px;font-size: 11px; text-align:center;" value="<?=($_GET['id']>0)? $edit_value->item_price : $batch_get->d_price;?>"  required="required" step="any" min="0.01" class="item_price" />
                       </td>
