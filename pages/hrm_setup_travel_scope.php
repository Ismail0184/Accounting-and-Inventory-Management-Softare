...
$now=time();
$unique='ID';
$unique_field='scope_name';
$table="travel_scope";
$page="hrm_setup_travel_scope.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
                            ...
                            <div class="x_content">
                                ...
                                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Travel Scope<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
