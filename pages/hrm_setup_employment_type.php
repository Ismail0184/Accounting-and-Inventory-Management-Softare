...
$now=time();
$unique='id';
$unique_field='employment_type_name';
$table="employment_type";
$page="hrm_setup_employment_type.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
                            ...
                            <div class="x_content">
                                ...
                                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Employment Type<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
