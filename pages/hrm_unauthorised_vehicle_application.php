...
$title="Un-Authorized Vehicle Application List";
$dfrom=date('Y-1-1');
$dto=date('Y-m-d');
...
$page="hrm_unauthorised_vehicle_application.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
...
mail($to,$subject,$txt,$headers); 
                       ...
                       echo "<script>window.close(); </script>";
								...
								?>
                                     ...
                                     <?php if($current_status!=$required_status){ echo '<h5 style="text-align:center; color:red; font-weight:bold"><i>This requisition has been Authorized!!</i></h5>';} else { ?>
                                     ...
                                     <tr><td> <div class="form-group">
                                          ...
                                          <td>                                          
                                           ...
                                           <button type="submit" onclick='return window.confirm("Are you confirm to Deleted?");' name="Deleted" id="Deleted" class="btn btn-danger">Cancel & Deleted</button>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                           <button type="submit" onclick='return window.confirm("Are you confirm to Recommended the Requisition?");' name="recommend" id="recommend" class="btn btn-success">Authorized & Forwored to HR</button>
                                            </div></div></td></tr></table>           
                                            <?php } ?>                               
