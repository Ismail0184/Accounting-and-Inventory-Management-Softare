    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <form  name="addem" id="addem" action="do.php" class="form-horizontal form-label-left" style="font-size: 11px" method="post">
                            ...
                            <td style="vertical-align: middle">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="select2_single form-control" style="width:100%; font-size: 11px" tabindex="-1" required="required"  name="dealer" id="dealer">
                                            <option></option>
                                            <?php foreign_relation('dealer_info', 'dealer_code', 'CONCAT(dealer_code," : ",dealer_custom_code," : ", dealer_name_e)', $dealer, 'canceled="YES"'); ?>
                                        </select>
                                        </div></div></td>
