...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Create Vendor</title>
...
if ($valid){
 ...
 $result=mysql_query("INSERT INTO `sales_customer` (ledgercode,sname,cp,cno,address,email,website,phone,fax,country,createby,createdate,companyid) VALUES 
...
(accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,ledgercode,ledger,companyid,createby,createdate,ip,mac) VALUES('Balance Sheet','RL170222002','Property and Assets','MG170222004','Current Assets','SUB170222002','Accounts Receivable','$ledgerid','$sname','$companyid','$createby','$createdate','$ip','$mac')");
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="x_content">
                 ...
                 <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Customer Ledger Name<span class="required">*</span>
                        </label>
