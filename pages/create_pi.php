        ...
        <div class="right_col" role="main">
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-12" style="width: 62%">
                        <div class="x_panel">
                            <div class="x_title">
                            ...
                            <div class="x_content">
                                ...
                                if(isset($initiate)){
                                    ...
                                    $_SESSION[initiate_create_PI]=$invoice;} // }
                                    ...
                                    <table align="center" style="width:100%">
                                        <tr>
                                            <td style="width:50%;">
                                                <div class="form-group" style="width: 100%">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="pi_issue_date"  required="required" name="pi_issue_date" value="<?php if($_SESSION[initiate_create_PI]){ echo date('m/d/y' , strtotime($inirow[pi_issue_date])); } else { echo ''; } ?>" class="form-control col-md-7 col-xs-12" style="width: 130px" ><br>
                                            ...
                                            <td style="width:50%"><div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 40%">PI NO<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="pi_id"   required="required" name="pi_id" value="<?php if($_SESSION[initiate_credit_note]){ echo $inirow[pi_id];} else { echo $_SESSION['POINONEW']; } ?>" class="form-control col-md-7 col-xs-12"  readonly style="width: 150px">
                                                    </div>
                                                </div>
                                            </td></tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" style="width: 40%">Party Name:<span class="required">*</span>
                                                    </label>

                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select class="select2_single form-control" style="width: 80%;margin-top: 2px;" tabindex="-1" required="required"  name="party_id" id="party_id" >

                                                            <option></option>
                                                            <?php
                                                            $result=mysql_query("SELECT  * FROM  lc_buyer where 1");
                                            ...
                                            <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="text" id="PBI_ID"  value="<?php if($_SESSION[initiate_credit_note]){ echo $inirow[PBI_ID];} else { echo ''; } ?>" name="PBI_ID" class="form-control col-md-7 col-xs-12"  style="width: 130px; margin-top: 5px">
                                        ...
                                        <tr> <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="c_no"  value="<?php if($_SESSION[initiate_credit_note]){ echo $inirow[Cheque_No];} else { echo ''; } ?>" name="c_no"  class="form-control col-md-7 col-xs-12" style="width: 130px; margin-top: 5px" ></div></div></td>
                                            ...
                                            <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="text" id="c_date"   value="<?php if($_SESSION[initiate_credit_note]){ echo date('m/d/y' , strtotime($inirow[Cheque_Date]));} else { echo ''; } ?>" name="c_date"  class="form-control col-md-7 col-xs-12"  style="width: 130px; margin-top: 5px">
                                                    </div></div></td></tr>
                                        ...
                                        <tr>
                                            <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="bank" id="bank" value="<?=$inirow[Cheque_of_bank]?>" class="form-control col-md-7 col-xs-12" style="width: 130px; margin-top: 5px">
                                                    </div></div> </td>
                                            ...
                                            <td><div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="remarks" id="remarks" value="<?=$inirow[remarks]?>" class="form-control col-md-7 col-xs-12" style="width: 130px; margin-top: 5px"></div></div></td>
                                        </tr></table>
                                    ...
                                    <div class="form-group" style="margin-left:40%; margin-top: 15px">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <?php if($_SESSION[initiate_credit_note]){  ?>
                                                ...
                                                <button type="submit" name="updateMAN" class="btn btn-success" onclick='return window.confirm("Are you confirm to Update?");'>Update Receipt Voucher</button>

                                            <?php   } else {?>
                                                <button type="submit" name="initiate" class="btn btn-success">Initiate Receipt Voucher</button>
                                            <?php } ?>
                                        </div></div>
                                </form></div></div></div>
                    ...
                    <div class="col-md-6 col-xs-12" style="width: 38%">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Recent PI List</h2>
                                <div class="clearfix"></div>
                            </div>

                            <div class="x_content">
                                <div class="box2" style="overflow:scroll; height:224px; width:350px; font-size: 12px">
...
from  journal a where a.tr_from='Receipt' and a.user_id='$_SESSION[userid]' and a.section_id='$_SESSION[sectionid]' and a.company_id='$_SESSION[companyid]'  group by a.tr_no  order by a.tr_no desc limit 10";
                    ...
                    if($_SESSION[initiate_credit_note]){
                                    ...
                                    <table style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="width:8%">
                                                <input type="text" id="dr_amt" style="width:100px; height:30px; font-size: 12px; text-align:center"    name="dr_amt" placeholder="Dr Amount" class="form-control col-md-7 col-xs-12" autocomplete="off" >
                                                <input type="text" id="cr_amt" style="width:100px; height:30px; font-size: 12px; text-align:center; margin-top: 10px"    name="cr_amt" placeholder="Cr Amount" class="form-control col-md-7 col-xs-12" autocomplete="off" ></td>
                        ...
                        while($uncheckrow=mysql_fetch_array($rs)){
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:middle; width: 20%">
                                    <input type="text" id="upnarration<?php echo $ids; ?>" style="width:98%; height:37px; font-weight:bold; text-align:center;"    name="upnarration<?php echo $ids; ?>"  value="<?=$uncheckrow[narration] ;?>" class="form-control col-md-7 col-xs-12" autocomplete="off"  >
                                </td>

                                <td align="center" style="width:6%; text-align:center">
                                    <input type="text" id="updr_amt<?php echo $ids; ?>" style="width:110px; margin-left:1%; height:37px; font-weight:bold; text-align:center; float:none"    name="updr_amt<?php echo $ids; ?>"  value="<?=$uncheckrow[dr_amt] ;?>" class="form-control col-md-7 col-xs-12" autocomplete="off" <? if($uncheckrow[dr_amt]==0) echo  'readonly';?> ></td>


                                <td align="center" style="width:6%; text-align:center">
                                    <input type="text" id="upcr_amt<?php echo $ids; ?>" style="width:90px; margin-left:1%; height:37px; font-weight:bold; text-align:center; float:none"    name="upcr_amt<?php echo $ids; ?>"  value="<?=$uncheckrow[cr_amt] ;?>" class="form-control col-md-7 col-xs-12" autocomplete="off" <? if($uncheckrow[cr_amt]==0) echo  'readonly';?> ></td>
                        ...
                        <tr>
                            <td colspan="9" style="text-align:center">
                                ...
                                if(isset($cancel)){
                                    ...
                                    <meta http-equiv="refresh" content="0;credit_note.php">
                                <?php } ?>
                                <button type="submit" name="cancel" onclick='return window.confirm("Mr. <?php echo $_SESSION["username"]; ?>, Are you sure you want to Delete the Voucher?");' class="btn btn-primary">Delete the Voucher </button>
                                <?php if($totaldr==$totalcr){ ?>
                                    <button type="submit" name="confirmsave" class="btn btn-success">Confirm and Finish Voucher </button>
                                <?php } else { ?>
                                    <font  style="font-size: 22px; color: red; font-weight: bold">Invalid Credit Voucher!!</font>
                                <?php } ?>
