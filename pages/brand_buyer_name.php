...
$title="Brand Buyer Name";

$now=time();
$unique='id';
$unique_field='brand_buyer_name';
$table="lc_brand_buyer";
$page="brand_buyer_name.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
                            ...
                            <div class="x_content">
                                ...
                                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Brand Buyer Name<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="brand_buyer_name" style="width:100%"  required   name="brand_buyer_name" value="<?=$brand_buyer_name?>" class="form-control col-md-7 col-xs-12" >
                                    </div></div>
