          ...
          <div class="">
            ...
            <div class="row">
			  ...
			  ?>
                    ...
                    <h2>Vendor Name: <b style="color:#F00"><?php echo $vendorname; ?></b></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table style=" width:100%" id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
				$result=mysql_query("Select distinct invoiceno from transaction_inventory where vendorid='$_GET[ledgercode]' and tfor='Sales' and transactiontype='Credit Sales' and companyid='$_SESSION[companyid]' order by invoiceno");
				while($row=mysql_fetch_array($result)){ ?>
					
					<tr bgcolor="#999999"><td colspan="6" style="color:#00F; font-weight:bold; font-size:15px; "><?php echo $row[invoiceno]; ?></td></tr>
				
				 
                 
                 <?php
				 $resuls=mysql_query("select * from transaction_inventory where vendorid='$_GET[ledgercode]' and tfor='Sales' and transactiontype='Credit Sales' and companyid='$_SESSION[companyid]'");
				 while($venrow=mysql_fetch_array($resuls)){
				  ...
				  ?>
                      <tr>
                        ...
                        <td align="left"><?php echo $venrow[product]; ?></td>
                        <td align="right"><?php echo substr($venrow[qty],1); ?></td>
