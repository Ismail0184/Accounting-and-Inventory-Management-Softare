...
$QC_STO_checked=find_a_field('production_issue_master','COUNT(pi_no)','verifi_status="UNCHECKED"');
$QC_GRN_checked=find_a_field('purchase_receive','COUNT(distinct pr_no)','status in ("UNCHECKED")');
