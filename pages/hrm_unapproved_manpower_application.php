...
$title="Un-Approved Manpower Application List";
$dfrom=date('Y-1-1');
$dto=date('Y-m-d');
...
$page="hrm_unapproved_manpower_application.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
             ...
             <table class="table table-striped table-bordered" style="width:100%;font-size:12px">
				 ...
				 (SELECT concat(p2.PBI_NAME," # ","(",de.DESG_SHORT_NAME,")") FROM 
							...
							designation de 
							 ...
							 p2.PBI_DEPARTMENT=d.DEPT_ID) as Req_By,r.no_of_vacancies,r.Priority,(select PBI_NAME from personnel_basic_info where PBI_ID=r.authorise_by) as authorised_person
				  from '.$table.' r
				  WHERE 
...
?>
								...
								mysql_query("Update ".$table." SET status='RECOMMENDED',recommend_at='$todayss' where ".$unique."=".$_GET[$unique]."");
