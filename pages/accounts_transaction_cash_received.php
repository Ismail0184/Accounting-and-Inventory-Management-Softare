...
function reload(form)
{
	...
	self.location='accounts_transaction_cash_received.php?ledgercode=' + val ;
}
...
echo "Data Successfully Saved $ledgerrow[ledger]";
				cashreceivedid(); ?>
                <meta http-equiv="refresh" content="0;accounts_transaction_cash_received.php">
...
<?php }} ?>                    
                    ...
                    <form class="form-horizontal form-label-left" method="post">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Party Ledger</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_single form-control" style="width:100%" tabindex="1"  name="invoiceno" >
                            ...
                            <?php 
							$result=mysql_query("Select * from transaction_cash where ledgercode='$_GET[ledgercode]' and companyid='$_SESSION[companyid]' order by VNumber");
							while($row=mysql_fetch_array($result)){ ?>
								
								
                        <option  value="<?php echo $row[VNumber]; ?>"><?php echo $row[VNumber]; ?></option>
                    <?php } ?>
                          </select>
                        </div>
                      </div>
