...
<html lang="en">
  ...
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Sales List</title>
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <thead>
                        ...
                        <tr>
                          ...
                          <th style="width:20%">Sales Type</th>
				...
				$result=mysql_query("Select distinct invoiceno from transaction_inventory where tfor='Sales' and companyid='$_SESSION[companyid]' order by 	invoiceno");
				...
				$i=$i+1;
				 ...
				 ?>
                      ...
                      <tr>
                        ...
                        <td><?php echo $invrow[transactiontype];; ?></td>
...
<a href="sales_challan_view.php?type=delete&challanviewid=<?php echo $row[invoiceno]; ?>" target="_new" class="btn btn-danger btn-xs">
