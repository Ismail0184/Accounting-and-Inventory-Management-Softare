...
function reload(form)
{
	...
	self.location='accounts_budget.php?ledgercode=' + val  ;
}
</script>
    </head>
...
$result=mysql_query("INSERT INTO `accounts_budget` 
(budgetid,ledgerid,ledger,subledgercode,subledger,budgetamount,fromdate,todate,companyid,createby,createdate,ip,mac) VALUES('$budgetid','$ledgercode','$ledger','$subledgercode','$subledger','$budgetamount','$fromdate','$todate','$companyid','$inputby','$create_date','$ip','$mac')");

	accountsbudgetid(); ?>
    <meta http-equiv="refresh" content="0;accounts_budget.php"><?php }}  ?>
...
?>       
 ...
 <!------------------------------------------------Ledger ---------------------------------------------->              
  ...
  <!------------------------------------------------Department ---------------------------------------------->              
                ...
                <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Sub Ledger/Department<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<?php if($_GET[type]){ ?>
                        <input type="text" id="first-name" required="required" value="<?php echo $rowledgers[ledger] ?>" name="subledger" class="form-control col-md-7 col-xs-12" readonly><?php } else { ?>
                        
                        
                        <select id="first-name" required="required"   name="subledger" class="form-control col-md-7 col-xs-12">
                        <option value="">Choose ......</option>
                        
                        <?php $result=mysql_query("Select * from accounts_subledger where companyid='$_SESSION[companyid]' order by subledger");
						while($rowsubmaingroup=mysql_fetch_array($result)){ ?>
                  <option  value="<?php echo $rowsubmaingroup[subledgercode]; ?>"><?php echo $rowsubmaingroup[subledger]; ?></option>
...
<!------------------------------------------------- ledger---------------------------------------------------------->			   
               ...
               <div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" >From Date<span class="required">*</span></label>
               <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id="first-name" required="required" value="<?php echo date('Y-m-01') ?>" name="fromdate" class="form-control col-md-7 col-xs-12"></div></div>
              ...
              <?php if($_GET[type]=='edit'){ ?>
               ...
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" >From Date<span class="required">*</span></label>
               <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id="first-name" required="required" value="<?php echo $rowledgers[ledger] ?>" name="fromdate" class="form-control col-md-7 col-xs-12"></div></div><?php } ?>
...
<div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" >To Date<span class="required">*</span></label>
               <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id="first-name" required="required" value="<?php echo date('Y-m-30') ?>" name="todate" class="form-control col-md-7 col-xs-12"></div></div>
              ...
              <?php if($_GET[type]=='edit'){ ?>
               ...
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" >To Date<span class="required">*</span></label>
               <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id="first-name" required="required" value="<?php echo $rowledgers[budgetamount] ?>" name="todate" class="form-control col-md-7 col-xs-12"></div></div><?php } ?>
               ...
               <div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" >Budget Amount<span class="required">*</span></label>
               <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id="first-name" required="required" value="<?php echo $rowledgers[ledger] ?>" name="subledger" class="form-control col-md-7 col-xs-12"></div></div>
...
<?php } ?>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				$result=mysql_query("Select * from accounts_budget where companyid='$_SESSION[companyid]'  order by createdate");
