...
$title="Un-Checked Asset Purchase";
$dfrom=date('Y-1-1');
$dto=date('Y-m-d');
...
mail($to,$subject,$txt,$headers); 
                       ...
                       echo "<script>window.close(); </script>";
								...
								?>
                                     ...
                                     <?php if($current_status!=$required_status){ echo '<h6 style="text-align:center; color:red; font-weight:bold"><i>This purchase order has been checked!!</i></h6>';} else { ?>
                                           ...
                                           <button type="submit" name="Return" id="Return" style="font-size:12px; float:left; margin-left:1%" class="btn btn-danger" onclick='return window.confirm("Are you confirm to Return?");'>Return the Purchase Order</button>
                                            ...
                                            <button type="submit" style="font-size:12px; float:right" onclick='return window.confirm("Are you confirm to Checked the Purchase Order?");' name="checked" id="checked" class="btn btn-success">Checked & Forward</button>
