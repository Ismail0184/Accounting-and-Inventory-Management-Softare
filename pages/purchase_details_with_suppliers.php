...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="right_col" role="main">
          ...
          <div class="">
            ...
            <div class="row">
			  ...
			  $vendorname=getSVALUE("accounts_ledger", "ledger", "where  ledgercode='$_GET[ledgercode]' and companyid='$_SESSION[companyid]'");

			  ?>

                    

                    <h2>Supplier's Name: <b style="color:#F00"><?php echo $vendorname; ?></b></h2>
				...
				$result=mysql_query("Select distinct invoiceno from transaction_inventory where purchaseclint='$_GET[ledgercode]' and tfor='Purchase'  and companyid='$_SESSION[companyid]' order by invoiceno,tdate  DESC");
	...
	<tr style="height:15px; border:none"><td colspan="6" style="color:#00F; font-weight:bold; font-size:15px;  "><?php echo $row[invoiceno]; ?></td></tr>
				 ...
				 $resuls=mysql_query("select * from transaction_inventory where purchaseclint='$_GET[ledgercode]' and invoiceno='$row[invoiceno]' and tfor='Purchase'  and companyid='$_SESSION[companyid]'");
				 ...
				 $ratetotals=number_format($ratetotal,2);
				  ...
				  ?>
						...
						<tr style="color:#F00; font-weight:bold; font-size:14px"><td colspan="3" align="right" style="">Invoice Total</td><td align="center"><?php echo $qtytotal; ?></td><td align="right"></td><td align="right"><?php echo $amounttotals; ?></td></tr>
						
						
						
					<?php 
					
					$qtytotalgrand=getSVALUE("transaction_inventory", "Sum(qty) as qty", " where purchaseclint='$_GET[ledgercode]' and companyid='$_SESSION[companyid]'");
				  ...
				  $amounttotalgrand=getSVALUE("transaction_inventory", "Sum(amount) as amount", " where purchaseclint='$_GET[ledgercode]' and companyid='$_SESSION[companyid]'");
				  $amounttotalgrands=number_format($amounttotalgrand,2);
					?>	
                      ...
                      <tr style="color:#F00; font-weight:bold; font-size:14px"><td colspan="3" align="right" style="">Grand Total of <?php echo $vendorname; ?></td><td align="center"><?php echo $qtytotalgrand; ?></td><td align="right"></td><td align="right"><?php echo $amounttotalgrands; ?></td></tr>
