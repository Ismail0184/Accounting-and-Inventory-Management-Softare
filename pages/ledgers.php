...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Select Ledger</title>
...
function reload1(form)
{
	...
	var val3=form.subledgercode.options[form.subledgercode.options.selectedIndex].value;
	var val4=form.datefrom.options[form.datefrom.options.selectedIndex].value;
	var val5=form.dateto.options[form.dateto.options.selectedIndex].value;
	
	var val7=form.ledgercode.options[form.ledgercode.options.selectedIndex].value;
	self.location='ledgers.php?reporttypes=' + val +'&ledgercode=' + val7 ;
}
                    ...
                    <form class="form-horizontal form-label-left" method="get" action="reportview.php?">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_single form-control" style="width:100%" tabindex="-1"   required="required" name="ledgercode" >
                            <option></option>
                 ...
                 <option selected value="<?php echo $row[ledgercode]; ?>"><?php echo $row[ledger]; ?></option>
                  ...
                  <option  value="<?php echo $row[ledgercode]; ?>"><?php echo $row[ledger]; ?></option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_single form-control" style="width:100%" tabindex="-1"  name="subledgercode" >
                            ...
                            <?php 
							$result=mysql_query("Select distinct subledger,subledgercode from accounts_subledger where  companyid='$_SESSION[companyid]' order by subledger");
							while($row=mysql_fetch_array($result)){ ?>
                    ...
                    <?php } ?>
                             ...
                             <input type="hidden" class="form-control col-md-7 col-xs-12" id="first-name" name="datefrom"  placeholder="Year-month-date"  value="<?php echo $_GET[datefrom]; ?>">
                             
                             
                             
                             <input type="hidden" class="form-control col-md-7 col-xs-12" id="first-name" name="dateto"  placeholder="Year-month-date"  value="<?php echo $_GET[dateto]; ?>"> 
