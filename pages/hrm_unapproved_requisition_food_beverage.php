...
mysql_query("Update ".$table_details." SET recommend_qty=".$recommend_qty." where oi_no=".$_GET[$unique]." and id=".$req_data->id."");
                   ...
                   <tr>
                                ...
                                <td style="text-align:center"><?=$taken=getSVALUE("".$table_details."", "SUM(qty)", " where oi_date between '$dfrom' and '$dto' and  oi_no='".$_GET[$unique]."' and item_id=".$req_data->item_id."")-$req_data->qty;?> <?=$req_data->unit_name;?>'s</td>
...
///////////////////////// to authorise	
				...
				<p>Need your Authorization. Please enter Employee Access module to Authorise the Requisition.</p>
								...
								?>
                                     ...
                                     <tr><td> <div class="form-group">
                                          ...
                                          <td>                                          
                                             ...
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                           <button type="submit" name="Return" id="Return" class="btn btn-primary" onclick='return window.confirm("Are you confirm to Return?");'>Returned the Requisition</button>
                                             </div></div></td>
                                           ...
                                           <button type="submit" onclick='return window.confirm("Are you confirm to Deleted?");' name="Deleted" id="Deleted" class="btn btn-danger">Cancel & Deleted</button>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                           <button type="submit" onclick='return window.confirm("Are you confirm to Recommended the Requisition?");' name="recommend" id="recommend" class="btn btn-success">Recommended & Forward</button>
                                            </div></div></td></tr></table>           
                                            <?php } ?>                               
