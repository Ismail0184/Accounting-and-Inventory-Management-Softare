...
$title="Un-Authorised Food Requsition List";
$dfrom=date('Y-1-1');
$dto=date('Y-m-d');
...
$page="hrm_unauthorised_requisition_food_beverage.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
...
$cby=find_a_field('warehouse_other_issue','issued_to','oi_no='.$_GET[$unique]);
$creadtby=find_a_field('essential_info','ESS_CORPORATE_EMAIL','PBI_ID='.$getid[issued_to]);
///////////////////////// to authorise	
		...
		///////////////////////// to admin	
				$to = $hrexecutive;
				$subject = "Approved Food Requisition";
				$txt1 = "<p>Dear Admin,</p>
                                     ...
                                     <tr><td> <div class="form-group">
                                          ...
                                          <td>                                          
                                           ...
                                           <button type="submit" onclick='return window.confirm("Are you confirm to Deleted?");' name="Deleted" id="Deleted" class="btn btn-danger">Cancel & Deleted</button>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                           <button type="submit" onclick='return window.confirm("Are you confirm to Recommended the Requisition?");' name="authorised" id="authorised" class="btn btn-success">Authorized & Forward to HR</button>
                                            </div></div></td></tr></table>           
                                            <?php } ?>                               
