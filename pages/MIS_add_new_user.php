...
{   $condition=$unique."=".$$unique;
    ...
    { $$key=$value;}}
$resss='select '.$unique.','.$unique.' as ID,username as user_name,'.$unique_field.' as display_name,email,level,status from '.$table.' where dep_power_level not in ("APP") order by '.$unique;
?>
...
<?php if(!isset($_GET[$unique])){ ?>
    ...
    <div class="col-md-7 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <?=$crud->link_report_popup($resss,$link,$conn);?>
            </div>
            ...
            <div class="x_content">
                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post" style="font-size: 11px">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width:30%">Active Employee<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="select2_single form-control" style="width: 100%;" tabindex="-1"  name="PBI_ID" id="PBI_ID" onchange="javascript:reload(this.form)">
                                <option></option>
                                <? $sql_PBI_ID="SELECT  p.PBI_ID,concat(p.PBI_ID_UNIQUE,' : ',p.PBI_NAME,' : ',d.DEPT_SHORT_NAME) FROM 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="username" style="width:100%"  required   name="username" <?php if($_GET[$unique]){ echo 'readonly'; }  ?> placeholder="email, mobile or username"  class="form-control col-md-7 col-xs-12" >
                        </div></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="fname" style="width:100%"  required   name="fname" value="<?=find_a_field('personnel_basic_info','PBI_NAME','PBI_ID='.$_GET[PBI_ID].'');?>" <?php if($_GET[PBI_ID]){ echo'readonly';} ?>  class="form-control col-md-7 col-xs-12" >
                        </div></div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="password" id="password" style="width:100%"  required   name="password" <?php if($_GET[$unique]){ echo 'readonly'; }  ?>   class="form-control col-md-7 col-xs-12" >
                        </div></div>

                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 30%">Password Again<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="password" id="password" style="width:100%"  required   name="password" <?php if($_GET[$unique]){ echo 'readonly'; }  ?>  class="form-control col-md-7 col-xs-12" >
                        </div></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="email" id="email" style="width:100%"  required   name="email"  value="<?=find_a_field('personnel_basic_info','PBI_EMAIL','PBI_ID='.$_GET[PBI_ID].'');?>"  class="form-control col-md-7 col-xs-12" >
                        </div></div>

                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 30%">Gander<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="gander" style="width:100%"     name="gander"  value="<?=find_a_field('personnel_basic_info','PBI_SEX','PBI_ID='.$_GET[PBI_ID].'');?>"  class="form-control col-md-7 col-xs-12" >
                        </div></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="tel" id="mobile" style="width:100%"    name="mobile"  value="<?=find_a_field('personnel_basic_info','PBI_MOBILE','PBI_ID='.$_GET[PBI_ID].'');?>"  class="form-control col-md-7 col-xs-12" >
                        </div></div>
