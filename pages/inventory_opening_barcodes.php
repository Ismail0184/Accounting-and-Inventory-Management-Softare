...
function reload(form)
{
	...
	self.location='inventory_opening_barcodes.php?invoicecode=<?php echo $_GET[invoicecode]; ?>&product=' + val ;
}
...
function reload2(form)
{
	...
	self.location='inventory_opening_barcodes.php?invoicecode=<?php echo $_GET[invoicecode]; ?>&product=' + val + '&brandid=' + val3 ;
}
...
function reload3(form)
{
	...
	self.location='inventory_opening_barcodes.php?invoicecode=<?php echo $_GET[invoicecode]; ?>&product=' + val + '&brandid=' + val3 +'&modelid=' + val4;
}
...
<?php }}} ?>
                    ...
                    <form action="inventory_opening_barcode.php?inventorytype=<?php echo $_GET[inventorytype]; ?>&categoryid=<?php echo $_GET[categoryid]; ?>&brandid=<?php echo $_GET[brandid]; ?>&modelid=<?php echo $_GET[modelid]; ?>&invoicecode=<?php echo $_SESSION[ponos]; ?>" class="form-horizontal form-label-left" method="post">
            ...
            <option selected value="<?php echo $row[product]; ?>"><?php echo $row[product]; ?></option>
                  ...
                  <option  value="<?php echo $row[product]; ?>"><?php echo $row[product]; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_single form-control" style="width:100%" tabindex="-1" onchange="javascript:reload2(this.form)"  required="required" name="brand" >
                            <option></option>
                  ...
                  <option  value="<?php echo $row[brand]; ?>"><?php echo $row[brand]; ?></option>
                    <?php }} ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_single form-control" style="width:100%" tabindex="-1" onchange="javascript:reload3(this.form)"  required="required" name="model" >
                            <option></option>
...
<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_single form-control" style="width:100%" tabindex="-1"   required="required" name="warranty" >
