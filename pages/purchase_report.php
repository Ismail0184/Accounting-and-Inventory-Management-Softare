          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <thead>
                        ...
                        <tr>
                          ...
                          <th style=" width:13%">Purchase Type</th>
				...
				$result=mysql_query("Select distinct invoiceno from transaction_inventory where tfor='Purchase' and companyid='$_SESSION[companyid]' order by  tdate DESC,	invoiceno DESC");
				...
				$i=$i+1;
				 ...
				 ?>
                      ...
                      <tr>
                        ...
                        <td><a href="purchase_report.php?deleteidpurchase=<?php echo $row[invoiceno]; ?>"><?php echo $i; ?></a></td>
                        ...
                        <td style=" width:13%"><?php echo $invrow[transactiontype]; ?></td>
