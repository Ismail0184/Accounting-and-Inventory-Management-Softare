                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                              <select class="select2_single form-control" style="width:100%; font-size: 11px" tabindex="-1" name="BRANCH_ID" >
                                                  <option></option>
                                                  <?php foreign_relation('branch', 'BRANCH_ID', 'CONCAT(BRANCH_ID," : ", BRANCH_NAME)',1, '1'); ?>
                                              </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                              <select class="select2_single form-control" style="width:100%; font-size: 11px" tabindex="-1" name="AREA_CODE" >
                                                  <option></option>
                                                  <?php foreign_relation('area', 'AREA_CODE', 'CONCAT(AREA_CODE," : ", AREA_NAME)',1, 'Territory_CODE>0'); ?>
                                              </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                              <select class="select2_single form-control" style="width:100%; font-size: 11px" tabindex="-1" name="town_code" >
                                                  <option></option>
                                                  <?php foreign_relation('town', 'town_code', 'CONCAT(town_code," : ", town_name)',1, '1'); ?>
                                              </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                              <select class="select2_single form-control" style="width:100%; font-size: 11px" tabindex="-1" name="ledger_id" >
                                                  <option></option>
                                                  <?php foreign_relation('dealer_info', 'account_code', 'CONCAT(account_code," : ", dealer_name_e)',1, '1'); ?>
                                              </select>
                                          </div>
                                      </div>
