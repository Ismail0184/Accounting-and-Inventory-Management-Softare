                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post" style="font-size: 11px">
                                    ...
                                    <!--div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 40%">Item Description<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group" style="display: none">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <?php
                                            $a2="select sub_group_id, sub_group_name from item_sub_group where sub_group_id in ('500010000')";
                                            //echo $a2;
                                            $a1=mysqli_query($conn, $a2);
                                            echo "<select class=\"select2_single form-control\" name=\"sub_group_id\" id=\"sub_group_id\"\">";
                                    ...
                                    <div class="form-group" style="display: none">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="select2_single form-control" name="consumable_type" id="consumable_type">
                                    ...
                                    <div class="form-group" style="display: none">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="select2_single form-control" name="product_nature" id="product_nature">
                                                ...
                                                <option value="Salable" selected>Salable</option>
                                    ...
                                    <!--div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="select2_single form-control" name="item_brand" id="item_brand">
                                                ...
                                                <?php
                                                $brandresult=mysqli_query($conn, "Select * from brand");
                                                while($brandyrow=mysqli_fetch_array($brandresult)){ ?>
                                    ...
                                    <!--div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="select2_single form-control" name="sales_item_type" id="sales_item_type">
                                                ...
                                                <?php
                                                $item_typeresult=mysqli_query($conn, "Select * from item_type");
                                                while($typerow=mysqli_fetch_array($item_typeresult)){ ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            //echo $a2;
                                            $a1=mysqli_query($conn, $a2);
                                            echo "<select class=\"select2_single form-control\" required name=\"unit_name\" id=\"unit_name\"\">";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            //echo $a2;
                                            $a1=mysqli_query($conn, $a2);
                                            echo "<select class=\"select2_single form-control\" required name=\"pack_unit\" id=\"pack_unit\"\">";
                                            echo "<option value=\"\" selected></option>";
                                            while($a=mysqli_fetch_row($a1))
                                            {
                                                if($a[0]==$pack_unit)
