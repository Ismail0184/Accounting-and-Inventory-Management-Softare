...
<html lang="en">
  <head>
    ...
    <title>Batch Mates | Outbox</title>
                  ...
                  <div class="x_content">
                    <div class="row">
                      <div class="col-sm-3 mail_list_column">
                        ...
                        <?php
						 $select=mysql_query("SELECT * FROM conversation where  m_from='$_SESSION[m_id]' order by sent_date,sent_time");
						 while($row=mysql_fetch_array($select)){
							 
							 $ph=mysql_query("Select * from register where m_id='$row[m_to]'");
							 $rowss=mysql_fetch_array($ph);
							 
							 ?>
                        <a href="outbox.php?message_id=<?php echo $row[id]; ?>&send_to=<?php echo $row['m_to']; ?>">
                          <div class="mail_list">
                            <div class="left">
...
$results=mysql_query("Select * from conversation where id='$_GET[message_id]' and m_to='$_GET[send_to]'");
$rowm=mysql_fetch_array($results);
 $ph=mysql_query("Select * from register where m_id='$rowm[m_to]'");
							 $rowss=mysql_fetch_array($ph);
 ?>
                          ...
                          <div class="sender-info">
                            <div class="row">
                              <div class="col-md-12">
                                ...
                                <span>(<?php echo $rowss[user_email]; ?>)</span> from
                                <strong>me</strong>
