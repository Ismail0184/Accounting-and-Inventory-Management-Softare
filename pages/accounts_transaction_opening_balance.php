...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Cash Opening Balance</title>
...
function reload(form)
{
	...
	self.location='accounts_transaction_opening_balance.php?ledgercode=' + val ;
}
...
('$ledgerrow[accountreporttype]','$ledgerrow[rlid]','$ledgerrow[reportlevelname]','$ledgerrow[mgid]','$ledgerrow[maingroup]','$ledgerrow[subsidiaryid]','$ledgerrow[subsidiary]','$ledgerrow[ledgercode]','$ledgerrow[ledger]','$subledgercode','$subledger','$VNumber','$tdates','$amount','$amount','','$note0','0','$companyid','$_SESSION[login_email]','$ip','$create_date','$timess','Cash Opening','$invoiceno','$day','All','DR')");

// Party ledger start from here....

$cashtransaction=mysql_query("INSERT INTO transaction_cash (accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,ledgercode,ledger,subledgercode,subledger,VNumber,TDate,Amount,debitamount,creditamount,Note,SubID,companyid,Username,IPAdress,IDate,time,ttype,invoiceno,day,sectionname,journal) VALUES 
('$mcrow[accountreporttype]','$mcrow[rlid]','$mcrow[reportlevelname]','$mcrow[mgid]','$mcrow[maingroup]','$mcrow[subsidiaryid]','$mcrow[subsidiary]','$mcrow[ledgercode]','Capital A/c','$subledgercode','$subledger','$VNumber','$tdates','-$amount','','$amount','$note1','1','$companyid','$_SESSION[login_email]','$ip','$tdates','$timess','Cash Opening','$invoiceno','$day','All','CR')");

//echo "Data Successfully Saved $ledgerrow[ledger]";
				cashopeningbalance(); ?>
                <meta http-equiv="refresh" content="0;accounts_transaction_opening_balance.php">
...
<?php } ?>                    
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id="first-name" required="required" style="width:100%" value="<?php echo $_SESSION['cashopening']; ?>" name="VNumber" class="form-control col-md-7 col-xs-12" readonly></div></div>
               ...
               <input type="text" id="first-name" required="required" style="width:100%"  name="amount" class="form-control col-md-7 col-xs-12"></div></div>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <a href="accounts_transaction_opening_balance.php"  class="btn btn-primary">Cancel</a>
