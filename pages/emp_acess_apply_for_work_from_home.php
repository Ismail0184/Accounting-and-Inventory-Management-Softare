...
<?php require_once 'body_content.php'; ?>
             ...
             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width:25%">OD Date<span class="required">*</span></label>
                                        ...
                                        <input type="date" id="attendance_date"  required="required" name="attendance_date"  class="form-control col-md-7 col-xs-12" style="font-size:11px" value="<?=$attendance_date;?>">
