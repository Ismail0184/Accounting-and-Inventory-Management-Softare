...
$invoicedetails=mysql_query("Select * from transaction_inventory where invoiceno='$_GET[invoiceidedit]' and companyid='$_SESSION[companyid]'");
$invrow=mysql_fetch_array($invoicedetails);
 ?>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="x_content">
	            ...
	            <input type="text" id="last-name"  required="required" name="purchasedate" value="<?php echo $invrow[tdate]; ?>" class="form-control col-md-7 col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name"   required="required" name="invoice" value="<?php echo $invrow[invoiceno]; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>  
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name"   required="required" name="billno" value="<?php echo $invrow[voucherno]; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="vendor" required="required" value="<?php echo $invrow[vendor]; ?>" name="vendor" class="form-control col-md-7 col-xs-12" ></div></div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="first-name" required="required" value="<?php echo $invrow[vendorphone]; ?>" name="vendorphone" class="form-control col-md-7 col-xs-12" ></div></div>
                        ...
                        <input type="text" id="first-name" required="required" value="<?php echo $invrow[vendoraddress]; ?>" name="vendoraddress" class="form-control col-md-7 col-xs-12" ></div></div>
			  ...
			  $totalamount=getSVALUE("transaction_inventory", "SUM(amount) as amount", "where invoiceno='$_GET[invoiceidedit]'  and companyid='$_SESSION[companyid]'");
				
				
				// edit sata callection code
				$qtyssss=getSVALUE("transaction_inventory", "qty", "where productcode='$productrow[productcode]' and 	invoiceno='$_GET[invoiceidedit]'  and companyid='$_SESSION[companyid]'");
				$qtysssss=substr($qtyssss,1);
				
				// edit sata callection code
			$qtyts=getSVALUE("transaction_inventory", "qty", "where invoiceno='$_GET[invoiceidedit]'  and companyid='$_SESSION[companyid]'");
				$qtyt=substr($qtyts,1);
				
				$rateeee=getSVALUE("transaction_inventory", "rate", "where productcode='$productrow[productcode]' and invoiceno='$_GET[invoiceidedit]'  and companyid='$_SESSION[companyid]'");
			  
			  $ratts=getSVALUE("transaction_inventory", "rate", "where  invoiceno='$_GET[invoiceidedit]'  and companyid='$_SESSION[companyid]'");
			  
			  $amounttttt=getSVALUE("transaction_inventory", "amount", "where productcode='$productrow[productcode]' and invoiceno='$_GET[invoiceidedit]'  and companyid='$_SESSION[companyid]'");
			  
			  
			  
			  $duet=$totalamount-$invrow[discount]-$invrow[advance];
...
<?php }}}
				 ...
				 //if ($stockbalance>0) { ?>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row[brand]; ?> - <?php echo $row[model]; ?> - <?php echo $row[product]; ?></td>
 ...
 <td align="center"><input type="text" readonly id="last-name"  style="width:80px; color:#F00; font-weight:bold; text-align:center" name="sbalance<?php echo $ids; ?>" value="<?php if($stockbalance>0)  { echo $stockbalance; } else { echo 0;} ?>" class="form-control col-md-7 col-xs-12"></td>
                     ...
                     <input type="text" id="last-name" style="width:80px; height:35px; font-size:13px; text-align:center" autocomplete="off"  class='price' name="qtys<?php echo $ids; ?>" value="<?php echo $qtysssss; ?>" >
                     
                     
                     </td>
                      
                     <td align="center"><input type="text" id="last-name" autocomplete="off"    name="rate<?php echo $ids; ?>" style="width:80px; height:35px; font-size:13px; text-align:center" class='rate' value="<?php echo $rateeee; ?>"  ></td>
                      
                    <td align="center"><input type="text"  id='amounta' autocomplete="off"    name="rate<?php echo $ids; ?>" style="width:80px; height:35px; font-size:13px; text-align:center" class='amount' value="<?php echo $amounttttt; ?>"  ></td>
                      ...
                      <td align="center" ><input  type='text' id='totalPrice' class="form-control col-md-7 col-xs-12" style="text-align:center;width:100px; height:35px;" value="<?php echo $qtyt; ?>"  disabled / ></td>
                      
                      <td align="center"><input  type='text' value="<?php echo $ratts; ?>"  id='totalRate' class="form-control col-md-7 col-xs-12" style="text-align:center; width:100px; height:35px;" disabled /></td>
                      
                      <td align="center"><input  type='text' id='totalAmount' value="<?php echo $totalamount; ?>"  class="form-control col-md-7 col-xs-12" style="text-align:center; width:100px; height:35px;" disabled /></td>
                      
                      </tr>
                      
                       <tr><td colspan="5" style="font-weight:bold" align="right">Total Amount</td>
                      <td colspan="3"><input type='text' id='totalAmounts' class="form-control col-md-7 col-xs-12" style="text-align:center;width:335px; height:35px;" value="<?php echo $totalamount; ?>" disabled / ></td></tr>
                      
                      
                      <tr><td colspan="5" style="font-weight:bold" align="right">Discount</td>
                      <td colspan="3"><input type='text' id='tb1' name="tb1" autocomplete="off" onkeyup="calculateTotal()" class="form-control col-md-7 col-xs-12" style="text-align:center;width:335px; height:35px;" value="<?php echo $invrow[discount]; ?>" ></td></tr>
                      
                      
                      <tr><td colspan="5" style="font-weight:bold" align="right">Advance</td>
                      <td colspan="3"><input type='text' id='tb2' name="tb2" autocomplete="off" value="<?php echo $invrow[advance]; ?>"  onkeyup="calculateTotal()" class="form-control col-md-7 col-xs-12" style="text-align:center;width:335px; height:35px;"  ></td></tr>
                      
                      <tr><td colspan="5" style="font-weight:bold" align="right">Total Balance</td>
                      <td colspan="3">
                      ...
                      <button type='text'  class="form-control col-md-7 col-xs-12" style="text-align:center;width:335px; vertical-align:middle; height:35px;"  disabled ><span id="update"><?php echo $duet; ?></span></button>
                      
                   <!--input type="hidden" name="total" value="100" /--->
                   
                   <input type='hidden' id='total' value="<?php echo $totalamount; ?>" class="form-control col-md-7 col-xs-12" style="text-align:center;width:335px; height:35px;" disabled / >   
...
if ($valid){
 ...
 ('$prow[accountreporttype]','$prow[rlid]','$prow[reportlevelname]','$prow[mgid]','$prow[maingroup]','$prow[subsidiaryid]','$prow[subsidiary]','$prow[ledgercode]','Sales','$billno','$createdate','','','-$amounts','','$amounts','Main Cash, Sales to  $vendor','0','','','','$companyid','','$createby','$ip','$mac','$createdate','$ttime','Cash Sales','$invoice','Edited','$day')");		
 
 
 
 
 $result=mysql_query("INSERT INTO `transaction_cash` (accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,ledgercode,ledger,	VNumber,TDate,qty,rate,Amount,debitamount,creditamount,Note,SubID,journal,Person,CheckNumber,companyid,company,Username,IPAdress,	MAC,IDate,time,ttype,invoiceno,status,day) VALUES 
 ('$mcrow[accountreporttype]','$mcrow[rlid]','$mcrow[reportlevelname]','$mcrow[mgid]','$mcrow[maingroup]','$mcrow[subsidiaryid]','$mcrow[subsidiary]','$mcrow[ledgercode]','Main Cash','$billno','$createdate','','','$amounts','$amounts','','Sales to  $vendor','1','','','','$companyid','','$createby','$ip','$mac','$createdate','$ttime','Cash Sales','$invoice','Edited','$day')");
 
		}
	} ?>

    
    <meta http-equiv="refresh" content="0;sales_challan_view.php?challanviewid=<?php echo $_GET[invoiceidedit]; ?>">
<?php 	}      ?>                
                  <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" name="getstarted" class="btn btn-success">Finish This Sales </button>
