                                ...
                                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="select2_single form-control" style="width:100%" name="category_id" id="category_id">
                                                <option></option>
                                                <?	$sql="select * from cost_category order by id";
                                                $query=mysql_query($sql);
                                                while($datas=mysql_fetch_object($query))
                                                { ?>
                                                <option <? if($datas->id==$category_id) echo 'Selected ';?> value="<?=$datas->id?>">
                                                    <?=$datas->category_name?>
                                                </option><? } ?>
                                            </select>
                                        </div></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if($_GET[id]){  ?>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            <button type="submit" name="record" id="record"  class="btn btn-primary">Add New Cost Center</button>
                                            </div></div>                                                                                        
                                            <?php } ?> 
