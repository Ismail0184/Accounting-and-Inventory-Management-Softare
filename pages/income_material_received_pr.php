...
$unique_field='name';
$table="";
$page="income_material_received_pr.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
...
mm.MAN_ID=md.MAN_ID AND 
mm.warehouse_id=w.warehouse_id AND 
MM.entry_by=u.user_id AND 
MM.status='CHECKED'
