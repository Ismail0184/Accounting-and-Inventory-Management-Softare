...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Bank Expenses Transaction</title>
...
function reload(form)
{
	...
	self.location='accounts_transaction_bank_received.php?ledgercode=' + val ;
}
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Bank Expenses Transaction</h2>
			...
			$subleresult=mysql_query("Select * from accounts_subledger where ledgercode='$_GET[ledgercode]' and companyid='$_SESSION[companyid]'");
...
$mcresult=mysql_query("Select * from accounts_ledger where ledgercode='$ledger' and companyid='$_SESSION[companyid]'");
...
('$ledgerrow[accountreporttype]','$ledgerrow[rlid]','$ledgerrow[reportlevelname]','$ledgerrow[mgid]','$ledgerrow[maingroup]','$ledgerrow[subsidiaryid]','$ledgerrow[subsidiary]','$ledgerrow[ledgercode]','$ledgerrow[ledger]','$subledgercode','$subledger','$VNumber','$tdates','$amount','$amount','','$note0','0','$companyid','$_SESSION[login_email]','$ip','$create_date','$timess','Bank Received','$invoiceno','$day','All','DR')");

// Party ledger start from here....

$cashtransaction=mysql_query("INSERT INTO transaction_cash (accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,ledgercode,ledger,subledgercode,subledger,VNumber,TDate,Amount,debitamount,creditamount,Note,SubID,companyid,Username,IPAdress,IDate,time,ttype,invoiceno,day,sectionname,journal) VALUES 
('$mcrow[accountreporttype]','$mcrow[rlid]','$mcrow[reportlevelname]','$mcrow[mgid]','$mcrow[maingroup]','$mcrow[subsidiaryid]','$mcrow[subsidiary]','$mcrow[ledgercode]','$mcrow[ledger]','$subledgercode','$subledger','$VNumber','$tdates','-$amount','','$amount','$note1','1','$companyid','$_SESSION[login_email]','$ip','$tdates','$timess','Bank Received','$invoiceno','$day','All','CR')");

echo "Data Successfully Saved $ledgerrow[ledger]";
				svoucherid(); ?>
                <meta http-equiv="refresh" content="0;accounts_transaction_bank_received.php">
...
<?php } ?>                    
                    ...
                    <form class="form-horizontal form-label-left" method="post">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_single form-control" style="width:100%" tabindex="-1" onchange="javascript:reload(this.form)"  required="required" name="bank" >
                            <option></option>
                            
                            <?php 
							$result=mysql_query("Select * from accounts_ledger where subsidiary='Cash at Bank' and companyid='$_SESSION[companyid]' order by ledger");
               ...
               <div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" >Bank Cheque Number<span class="required">*</span></label>
               
               <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id="first-name" required="required" style="width:100%"  name="VNumber" class="form-control col-md-7 col-xs-12"></div></div>
...
<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Expenses For</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_single form-control" style="width:100%" tabindex="-1"   required="required" name="ledger" >
                            <option></option>
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" id="first-name" required="required" style="width:100%"  name="amount" class="form-control col-md-7 col-xs-12"></div></div>
