...
<?php
$re=mysql_query("Select * from sales_customer where id='$quorow[vendorid]' and companyid='$_SESSION[companyid]'");
$venrow=mysql_fetch_array($re);

 ?>
<tr><td>Customer To</td>      <td>:</td> <td> <?php echo $quorow[vendorname]; ?></td></tr>
<tr><td>Contact Number</td> <td>:</td> <td> <?php echo $quorow[mobileno]; ?></td></tr>
<tr><td>Address</td> <td>:</td> <td> <?php echo $quorow[address]; ?></td></tr>
...
<thead style="font-size:14px; background-color:#CCC">
<tr style="height:30px; font-size:14px; border:solid 1px #000;">
<th style="border:solid 1px #000;">SL</th>
...
while($row=mysql_fetch_array($result)){
	...
	$amountotals=number_format($amountotal,2);
	 ...
	 ?>
<tr align="center" style="border:solid 1px #000;"><td style="border:solid 1px #000;"><?php echo $i; ?></td>
<td align="left" style="border:solid 1px #000;"><?php echo $row[category]; ?>-<?php echo $row[brand]; ?>-<?php echo $row[model]; ?>-<?php echo $row[product]; ?></td>
<td align="center" style="border:solid 1px #000;"><?php echo $row[unit]; ?></td>
<td align="center" style="border:solid 1px #000;"><?php echo $row[qty]; ?></td>
<td align="right" style="border:solid 1px #000;"><?php echo $row[rate]; ?></td>
<td align="right" style="border:solid 1px #000;"><?php echo $amounts; ?></td>
<td align="right" style="border:solid 1px #000;"><?php echo $row[remarks]; ?></td></tr>

<?php } ?>

<tr style="background-color:#CCC; font-weight:bold; font-size:14px"><td colspan="3" align="right" style="border:solid 1px #000;">Total</td>
<td align="center" style="border:solid 1px #000;"><?php echo $qtytotal; ?></td>
<td align="right" style="border:solid 1px #000;"><?php echo $pricetotals; ?></td>
<td align="right" style="border:solid 1px #000;"><?php echo $amountotals; ?></td>
<td></td>
...
<table align="left" style="width:75%; margin-top:70px; float:left; border:solid 1px #000; font-size:14px">
<thead>
...
<tr style=""><td><?php echo $rows[tandc]; ?></td></tr>


</tbody>
</table>

<table align="left" style="width:50%; margin-top:50px; float:left; font-weight:bold; font-size:13px">
