...
///////////////////////// for nazmul
    ...
    if($wddid=='5'){
        ...
        $by=find_a_field('user_activity_management','fname','user_id='.$_SESSION['user']['id']);
    ...
    if($wddid=='5'){
        ...
        if($emailId!=''){
            ...
            $txt1 = "<p>Dear Masud Rana,</p>
				...
				<p>DO Created By- <b>".find_a_field('user_activity_management','fname','user_id='.$_SESSION['user']['id'])."<b></p>
