...
$page='QC_Code_to_Code_Transfer.php';
$ji_date=date('Y-m-d');
$crud      =new crud($table);
$$unique = $_GET[$unique];
...
mail($to,$subject,$message,$headers); 
		...
		$up_master=mysqli_query($conn,"UPDATE ".$table." SET status='CHECKED',checked_at='".$todayss."' where ".$unique."=".$$unique."");
        $up_details=mysqli_query($conn,"UPDATE ".$table_deatils." SET status='CHECKED' where ".$unique."=".$$unique."");
        $type=1;
        unset($_POST);
        echo "<script>window.close(); </script>";
    }}
...
<?php if(isset($_GET[$unique])){ ?>
 ...
 <?php
                                        ...
                                        <? } else {echo '<h6 style="text-align: center;color: red;  font-weight: bold"><i>This CTC has been checked by QC !!</i></h6>';}?>
