...
<?php require_once 'body_content.php'; ?>
         ...
         <select class="select2_single form-control" name="type" id="type" required style="width:91%" onchange="javascript:reload(this.form)">
              ...
              <th style="width:1%; text-align:center">:</th>
              <td><select class="select2_single form-control" style="width:207px;" tabindex="-1" required="required" name="leave_responsibility_name" id="leave_responsibility_name">
                                                <option></option>
              ...
              <tr>                    
              <th>Checke By</th>
              <th style="width:1%; text-align:center">:</th><td><select class="select2_single form-control" style="width:207px;" tabindex="-1" required="required" name="PBI_IN_CHARGE" id="PBI_IN_CHARGE">
                                                <option></option>
          ...
          <th style="width:1%; text-align:center">:</th>
          <td colspan="4">
              <input type="date" id="s_date" style="width:36%; font-size:11px" required="required" name="s_date" value="<?=$s_date?>" onchange="cal()" class="form-control col-md-7 col-xs-12" >
