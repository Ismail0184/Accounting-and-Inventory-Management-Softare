...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Purchase with Barcode</title>
...
function reload(form)
{
	...
	self.location='purchase_cash_barcode.php?invoicecode=<?php echo $_GET[invoicecode]; ?>&brandid=<?php echo $_GET[brandid]; ?>&modelid=<?php echo $_GET[modelid]; ?>&product=' + val ;
}
...
function reload2(form)
{
	...
	self.location='purchase_cash_barcode.php?invoicecode=<?php echo $_GET[invoicecode]; ?>&product=' + val + '&brandid=' + val3 ;
}
...
function reload3(form)
{
	...
	self.location='purchase_cash_barcode.php?invoicecode=<?php echo $_GET[invoicecode]; ?>&product=' + val + '&brandid=' + val3 +'&modelid=' + val4;
}
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Inventory Purchase with Barcode</h2>
...
<?php }}} ?>
                    ...
                    <form action="purchase_cash_barcode.php?inventorytype=<?php echo $_GET[inventorytype]; ?>&categoryid=<?php echo $_GET[categoryid]; ?>&brandid=<?php echo $_GET[brandid]; ?>&modelid=<?php echo $_GET[modelid]; ?>&invoicecode=<?php echo $_SESSION[ponos]; ?>&product=<?php echo $_GET[product]; ?>" class="form-horizontal form-label-left" method="post">
...
<div class="form-group">
                        ...
                        <select id="first-name" required="required"   name="supplier" class="select2_single form-control">
                        <option value="">Choose ......</option>
...
<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Purchase Invoice<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <?php }  ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <a href="purchase_cash_barcodes.php"  class="btn btn-primary">Cancel</a>
                          <button type="submit" class="btn btn-success" name="getstarted">Add</button>
                          
                          <a href="purchase_cash_barcode.php?inventorytype=&categoryid=&brandid=<?php echo $_GET[brandid]; ?>&modelid=<?php echo $_GET[modelid]; ?>&invoicecode=<?php echo $_GET[invoicecode]; ?>&product=<?php echo $_GET[product]; ?>" type="cancel" >Refresh</a>
...
<!----------------------------------data view code from here------------------------------->
 ...
 <?php 
							...
							<meta http-equiv="refresh" content="0;purchase_cash_barcode.php?type=delete&brandid=<?php echo $_GET[brandid] ?>&modelid=<?php echo $_GET[modelid] ?>&invoicecode=<?php echo $_GET[invoicecode] ?>&product=<?php echo $_GET[product] ?>">
...
<?php }} ?>
                    ...
                    <td align="center" style="width:10%">
                            ...
                            <a href="purchase_cash_barcode.php?type=delete&brandid=<?php echo $_GET[brandid] ?>&modelid=<?php echo $_GET[modelid] ?>&invoicecode=<?php echo $_GET[invoicecode] ?>&product=<?php echo $_GET[product] ?>&productdeletecode=<?php echo $row[id] ?>" class="btn btn-danger btn-xs"><i class="fa fa-pencil"></i> Delete </a>
 ...
 ?>                       
                   ...
                   <input type='hidden' id='total' value="<?php echo $amountsss; ?>" name="ttts" class="form-control col-md-7 col-xs-12" style="text-align:center;width:80px; height:35px;" disabled / >   </td>
                      ...
                      <td colspan="8" style="text-align:center">
                          ...
                          <button type="submit" name="getstarteds" class="btn btn-success">Confirm and Finish Purchase </button>
