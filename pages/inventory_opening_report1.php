              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    ...
                    <h2>Inventory Opening Report</h2>
				...
				$result=mysql_query("Select distinct invoiceno from transaction_inventory where tfor='Opening Inventory' and companyid='$_SESSION[companyid]' order by  tdate DESC,	invoiceno DESC");
				...
				$i=$i+1;
				 ...
				 ?>
                      ...
                      <tr>
                        ...
                        <td><a href="inventory_opening_report.php?deleteidopening=<?php echo $row[invoiceno]; ?>"><?php echo $i; ?></a></td>
...
<a href="purchase_invoice_view.php?type=delete&challanviewid=<?php echo $row[invoiceno]; ?>" target="_new" class="btn btn-danger btn-xs">
...
<i class="fa fa-pencil"></i> View </a>                
 ...
 if($_GET[deleteidopening]){
 
 
 
 $delete1=mysql_query("Delete From transaction_inventory where invoiceno='$_GET[deleteidopening]' and companyid='$_SESSION[companyid]'");
 
 $delete1=mysql_query("Delete From transaction_cash where invoiceno='$_GET[deleteidopening]' and companyid='$_SESSION[companyid]'");
 
 ?>
 <meta http-equiv="refresh" content="0;inventory_opening_report.php">
 <?php }  ?>             
