            ...
            <div class="x_content">
                <table class="table table-striped table-bordered" style="width:100%;font-size:11px">
                    ...
                    while($leavedata=mysqli_fetch_object($rquery)){  ?>
                        <tr style="cursor: pointer" onclick="DoNavPOPUP('<?=$leavedata->id?>', 'TEST!?', 900, 600)">
                            <td><?=$i=$i+1;?></td>
                            <td><?=$leavedata->id;?></td>
                            <td><?=$leavedata->req_date;?></td>
                            <td><?=$leavedata->PBI_NAME;?></td>
                            <td><?=$leavedata->DESG_DESC;?></td>
                            <td><?=$leavedata->purpose;?></td>
                            <td style="text-align: right"><?=$leavedata->amount;?></td>
                            <td><?php if($leavedata->recommended_date>0){?>
                            ...
                            <td><?php if($leavedata->authorized_date>0){?>
