...
$$unique = $_GET[$unique];
    ...
    {   $_SESSION[MIS_permission_matrix_dashboard]=$_POST[user_id];
        }
//for Delete..................................
    if(isset($_POST['cancel']))
    {unset($_SESSION[MIS_permission_matrix_dashboard]);}
...
// insert permission..................................
    ...
    $report_in_database=find_a_field('user_permissions_dashboard','COUNT(module_id)','module_id='.$module_id.' and user_id="'.$_SESSION[MIS_permission_matrix_dashboard].'"');
    if($module_id>0){
    if($report_in_database>0) {
        $sql = mysqli_query($conn, "UPDATE user_permissions_dashboard SET status='$status',powerby='$_SESSION[userid]',powerdate='".$now."',ip='".$ip."' WHERE module_id='" . $module_id . "' and user_id='" . $_SESSION[MIS_permission_matrix_dashboard] . "'");
    } else {
        $sql = mysqli_query($conn, "INSERT INTO user_permissions_dashboard (module_id,user_id,powerby,powerdate,status,section_id,companyid,ip) 
        VALUES ('$module_id','$_SESSION[MIS_permission_matrix_dashboard]','$_SESSION[userid]','$now','1','$_SESSION[sectionid]','$_SESSION[companyid]','$ip')");
    }}}
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
							...
							users u
							 ...
							 u.PBI_ID=p.PBI_ID		 
							  order by p.PBI_NAME";
                                advance_foreign_relation($sql_user_id,$_SESSION[MIS_permission_matrix_dashboard]);?>
                            </select>
                       <?php if(isset($_SESSION[MIS_permission_matrix_dashboard])){ ?>
...
<?php if(isset($_SESSION[MIS_permission_matrix_dashboard])){ ?>
    <div class="col-md-12 col-sm-12 col-xs-12">
       ...
       (select p.status from user_permissions_dashboard p where p.module_id=m.module_id and p.user_id='".$_SESSION[MIS_permission_matrix_dashboard]."') as status
