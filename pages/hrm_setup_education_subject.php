...
$now=time();
$unique='SUBJECT_CODE';
$unique_field='SUBJECT_NAME';
$table="edu_subject";
$page="hrm_setup_education_subject.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
                            ...
                            <div class="x_content">
                                ...
                                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Subject Name<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
