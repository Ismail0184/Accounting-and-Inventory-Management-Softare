                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post" style="font-size: 11px">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Branh Name<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="BRANCH" style="width:100%"  required   name="BRANCH" value="<?=$BRANCH?>" class="form-control col-md-7 col-xs-12" >
                                    </div></div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content" style="font-size: 11px">
                                <? 	$res='select '.$unique.','.$unique.' as Code,'.$unique_field.',BRANCH from '.$table.' order by '.$unique;
