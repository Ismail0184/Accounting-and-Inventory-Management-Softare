                ...
                <div class="row">
                    <div class="col" style="">
                        <a target="_blank" href="https://lobianijs.com">
                            <img src="../../logo/title.png" width="60%" data-holder-rendered="true" />
                        </a>
                    </div>
            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <div class="email">POC Name: <?php echo $dealer->contact_person.','.' Mobile: '.$dealer->contact_number;?></div>
                    </div>
                    <div class="col invoice-details">
                        <h3 class="invoice-id">INVOICE</h3>
                        <div class="date">Date of Invoice: <?php echo date('M d, Y',strtotime($do_date));?></div>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <? $sqlc = mysqli_query($conn, 'select c.*, i.item_name, i.unit_name, c.total_unit,c.total_amt,c.currency_amount from sale_do_details c, item_info i where i.item_id=c.item_id and i.finish_goods_code != 2001 and c.do_no='.$_GET[do_no].' group by c.item_id order by c.id asc');
                    ...
                    <tr>
                        ...
                        <td class="total"><?=number_format($datac->currency_amount,2);?></td>
                    </tr>
                    <?
                        $total_discount=$total_discount+$datac->discount_amount;
                        $total_amount=$total_amount+$datac->currency_amount;}?>
                    </tbody>
                    <tfoot>
                    <tr>
                        <td colspan="3"></td>
                    ...
                    <tr>
                        <td colspan="3"></td>
                        <td colspan="2">DISCOUNT (<?php if($pc_code=='2002001300000000'){ echo number_format($commission); } elseif($pc_code=='2002001400000000'){ echo number_format($commission); } ?>%)</td>
                        <td>BDT <?=$total_discount;?></td>
                    </tr>
                    <tr>
                        <td colspan="3"></td>
                        <td colspan="2">GRAND TOTAL</td>
                        <td>BDT <?=number_format($total_amount-$total_discount,2);?></td>
                    </tr>
                    </tfoot>
                </table>
                <p style="float: right" colspan="3">Amount in word: (<? echo convertNumberMhafuz($total_amount-$total_discount)?>)</p>
                ...
                <div class="notices">
                    ...
                    <div class="notice"><strong>Bank Details:</strong> NRB Bank Ltd. A/C No.- 1012010144781, Branch- Principal Branch.
                    </div>
                </div>
            </main>
            <footer>
