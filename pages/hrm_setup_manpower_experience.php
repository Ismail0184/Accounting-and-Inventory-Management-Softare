...
$now=time();
$unique='id';
$unique_field='related_experience';
$table="manpower_related_experience";
$page="hrm_setup_manpower_experience.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
                            ...
                            <div class="x_content">
                                ...
                                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 30%">Experience Title<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
