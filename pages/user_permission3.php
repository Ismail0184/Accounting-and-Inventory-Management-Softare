<?php
 ...
 $title='User Permission (Sub sub-Menu)';
?>
...
function reload(form)
{
	...
	self.location='user_permission3.php?user_id=' + val ;
}
</script>
...
function reload2(form)
{
	...
	self.location='user_permission3.php?user_id=<?=$_GET[user_id]?>&master_menu=' + val ;
}
</script>
...
{
	var val=form.sub_menu.options[form.sub_menu.options.selectedIndex].value;
	self.location='user_permission3.php?user_id=<?=$_GET[user_id]?>&master_menu=<?=$_GET[master_menu]?>&sub_menu=' + val ;
}
</script>
    </head>
...
mysql_query("INSERT INTO `user_permissions3`  VALUES ('','$_GET[master_menu]','$_GET[sub_menu]','$_POST[subsub_menu]','','$_GET[user_id]','$_SESSION[userid]','$create_date','sub-sub','$ip','','500001','','')");



	maingroupid(); ?>
    <meta http-equiv="refresh" content="0;user_permission3.php?user_id=<?=$_GET[user_id]?>&master_menu=<?=$_GET[master_menu]?>"><?php }}  ?>
...
?>       
               ...
               <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select id="first-name" required="required"   name="sub_menu" class="select2_single form-control" onchange="javascript:reload3(this.form)">                       
                        ...
                        <?php if(($_GET[sub_menu])==$subzonerow[zonecodesub]){    ?>  
                         <option selected value="<?php echo $subzonerow[zonecodesub]; ?>"><?php echo $subzonerow[zonename]; ?></option>
               ...
               <?php if($_GET[sub_menu]) { ?>
               <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Sub -Sub Menu<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        
                       
                        
                        <select id="first-name" required="required"   name="subsub_menu" class="select2_single form-control">                       
                        
                        <option value="">Choose......</option> 
                        <?php $zoneSUBsubresult=mysql_query("Select * from zone_subsub where zonecodemain='$_GET[master_menu]' and zonecodesub='$_GET[sub_menu]' order by zonenamesubsub");  
						while($zonecodesubsubROW=mysql_fetch_array($zoneSUBsubresult)){     ?>                 
                        <option  value="<?php echo $zonecodesubsubROW[zonecodesubsub]; ?>"><?php echo $zonecodesubsubROW[zonenamesubsub]; ?></option>
                        <?php } ?>
                        </select>
                        </div>
                      </div>
