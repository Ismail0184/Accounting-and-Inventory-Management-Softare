...
<html lang="en">
  <head>
    ...
    <title><?php echo $_SESSION[company]; ?> | Quotation</title>
...
function reload(form)
{
	...
	self.location='quotation.php?productcodeget=' + val ;
}
...
$billno=$_POST[billno];
$supplierledger=$_POST[supplierledger];
$vendor=$_POST[vendor];
...
$insert=mysql_query("INSERT INTO transaction_inventory_details (invoiceno,voucherno,invoice_date,customer_id,mobileno,address,companyid,supplierledger,tc,sub,exdate)  VALUES ('$invoice','$billno','$salesdate','$vendor','$vendorphone','$vendoraddress','$_SESSION[companyid]','$supplierledger','$tandc','$subject','$exdate')");	

$_SESSION[initiate_invoice_quotation]=$invoice;

//echo $_SESSION[initiate_invoice_quotation];
//unset($_SESSION["initiate_invoice_quotation"]);

}



$resultsssss=mysql_query("Select * from transaction_inventory_details where invoiceno='$_SESSION[initiate_invoice_quotation]' and companyid='$_SESSION[companyid]'");
...
?>
                 ...
                 <div class="form-group">
                   ...
                   <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Quotation Issut Date<span class="required">*</span></label>
                   <div class="col-md-6 col-sm-6 col-xs-12">
	                	
	            <input type="text" id="last-name"  required="required" name="salesdate" value="<?php echo date('Y-m-d'); ?>" class="form-control col-md-7 col-xs-12" <?php if($_SESSION[initiate_invoice_quotation]){ ?> readonly <?php } ?> >
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name"   required="required" name="invoice" value="<?php echo $_SESSION['quorefno']; ?>" class="form-control col-md-7 col-xs-12" <?php if($_SESSION[initiate_invoice_quotation]){ ?> readonly <?php } ?> >
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Quotation Subject<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						
                       
      <input type="text" id="first-name" required="required"  value="<?php if($_SESSION[initiate_invoice_quotation]){ ?><?php echo $inirow[sub] ?><?php } else { ?><?php } ?>" name="subject" class="form-control col-md-7 col-xs-12" <?php if($_SESSION[initiate_invoice_quotation]){ ?> readonly <?php } ?> >
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Company / Customer Name<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<?php if($_SESSION[initiate_invoice_quotation]){ ?>
                       
      <input type="text" id="first-name" required="required"  value="<?php echo $inirow[customer_id] ?>" name="vendor" class="form-control col-md-7 col-xs-12" readonly >
							<?php } else { ?>
      <input type="text" id="first-name"  value="" name="vendor" class="form-control col-md-7 col-xs-12"  >
      ...
      <input type="text" id="first-name" required="required"  value="<?php echo $inirow[mobileno] ?>" name="vendorphone" class="form-control col-md-7 col-xs-12" readonly >
							<?php } else { ?>
      <input type="text" id="first-name"  value="" name="vendorphone" class="form-control col-md-7 col-xs-12"  >
      ...
      <input type="text" id="first-name" required="required"  value="<?php echo $inirow[address] ?>" name="vendoraddress" class="form-control col-md-7 col-xs-12" readonly >
							<?php } else { ?>
      <input type="text" id="first-name"  value="" name="vendoraddress" class="form-control col-md-7 col-xs-12"  >
        ...
        <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="last-name" name="tandc" style="height:150px" class="form-control col-md-7 col-xs-12" <?php if($_SESSION[initiate_invoice_quotation]){ ?> readonly <?php } ?>><?php if($_SESSION[initiate_invoice_quotation]){ echo $inirow[tc];  } else {?>All Cheque payment will be made payable to: <?php echo $userRow[company]; ?>. VAT and TAX will be paid by Customer. Place of Delivery from <?php echo $userRow[company]; ?>, Bikrampur Plaza, Level-2, Shop No: 78, Jurain Railgate, Dhaka-1204.
Delivery to 7 days after getting work order or confirmation.<?php } ?></textarea>
                        </div>
                      </div>        
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
               <?php if($_SESSION[initiate_invoice_quotation]){ } else {?>
               <button type="submit" name="initiate" class="btn btn-success">Initiate Quotation</button>
               <?php } ?>
               </div></div>   
...
<!----------------------------------- initiate end--------------------------------------------------------------------->               
 ...
 <?php                    
                 ...
                 $catresult=mysql_query("Select * from inventory_product where productcode='$_GET[productcodeget]' and                  companyid='$_SESSION[companyid]'");
...
if ($valid){
 ...
 $result=mysql_query("INSERT INTO `transaction_inventorys` (inventory_types,categoryid,categorys,brandid,brand,modelid,model,productcode,product,unit,invoiceno,voucherno,Jvoucherno,vendor,vendorphone,vendoraddress,qty,rate,amount,coss,amtcoss,adjustlevel,adjustamount,lifofifoid,note,warehouse,acchead,btype,companyid,transactionby,transactiontype,ttime,tstatus,tdate,tmodifiddate,modifiedby,ip,mac,tfor,cus_invoice,warranty,purchaseclint) VALUES 
 ('$_GET[inventorytype]','$_GET[categoryid]','$category','$brand','$brand','$model','$model','$productcode','$product','$unit','$_SESSION[initiate_invoice_quotation]','$_SESSION[initiate_invoice_quotation]','$Jvoucherno','$suprows[sname]','$suprows[cno]','$suprows[address]','$qtys','$rate','$amounts','$prate','$amtcoss','$adjustlevel','$adjustamount','$lifofifoid','$note','Main House','$acchead','Quotation','$_SESSION[companyid]','$_SESSION[login_email]','Quotation','$timess','Normal','$idatess','$tmodifiddate','$modifiedby','$ip','$mac','Quotation','$_SESSION[ponos]','$warranty','$inirow[supplierledger]')");
...
if($_SESSION[initiate_invoice_quotation]){
...
<form action="" name="addem" id="addem" class="form-horizontal form-label-left" method="post">
 ...
 <table style="width:100%" id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <select class="select2_single form-control" style="width:250px" tabindex="-1" onchange="javascript:reload(this.form)"  required="required" placeholder="product code" name="productcode" >
                            <option></option>
                            
                            <?php 
							$result=mysql_query("SELECT distinct productcode FROM inventory_product where  companyid='$_SESSION[companyid]'");
							while($row=mysql_fetch_array($result)){
								
								
							$pname=getSVALUE("inventory_product", "product as product", "where productcode='$row[productcode]'   and companyid='$_SESSION[companyid]'");
							
							$modelss=getSVALUE("inventory_product", "model as model", "where productcode='$row[productcode]'   and companyid='$_SESSION[companyid]'");
							
							
							$brandss=getSVALUE("inventory_product", "brand as brand", "where productcode='$row[productcode]'   and companyid='$_SESSION[companyid]'");
                 ...
                 <option selected value="<?php echo $row[productcode]; ?>"><?php echo $pname; ?>-<?php echo $modelss; ?>-<?php echo $brandss ?></option>
                        <?php } else { ?>
                  <option  value="<?php echo $row[productcode]; ?>"><?php echo $pname; ?>-<?php echo $modelss ?>-<?php echo $brandss ?></option>
                    <?php }} ?>
                          </select></td>
...
<td style="width:5%">
                        <input type="text" id="vendor" style="width:80px; height:37px; color:red; font-weight:bold; text-align:center" readonly required="required" value="<?php echo $stockbalance ?>" name="stockbalance" class="form-control col-md-7 col-xs-12" >
                      </td>
                      
                      
                      
<td style="width:5%">
                        <input type="text" id="vendor" style="width:80px; height:37px; color:red; font-weight:bold; text-align:center" readonly required="required" value="<?php echo $rate ?>" name="prate" class="form-control col-md-7 col-xs-12" >
                      </td>
...
<td style="width:5%">
                        <input type="text" id="qtys" style="width:80px; height:37px; font-weight:bold; text-align:center"  required="required"  name="qtys" placeholder="qtys" onkeyup="calc(this)" autocomplete="off" class="form-control col-md-7 col-xs-12" >

</td>

<td style="width:5%">
                        <input type="text" id="rate" style="width:80px; height:37px;  font-weight:bold; text-align:center"  required="required"  name="rate" placeholder="rate" onkeyup="calc(this)" autocomplete="off" class="form-control col-md-7 col-xs-12" >
</td>
...
<?php 
							...
							<meta http-equiv="refresh" content="0;quotation.php">
...
<form id="ismail" name="ismail"  method="post"  class="form-horizontal form-label-left">
                     <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php
$resultssss=mysql_query("Select * from transaction_inventorys where companyid='$_SESSION[companyid]' and invoiceno='$_SESSION[initiate_invoice_quotation]'");
...
$supresult=mysql_query("Select * from accounts_ledger where ledgercode='$inirow[supplierledger]' and companyid='$_SESSION[companyid]'");
...
$result=mysql_query("INSERT INTO `transaction_cash` (accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,ledgercode,ledger,	VNumber,TDate,qty,rate,Amount,debitamount,creditamount,Note,SubID,journal,Person,CheckNumber,companyid,company,Username,IPAdress,	MAC,IDate,time,ttype,invoiceno,status,day) VALUES 
 ('$suprow[accountreporttype]','$suprow[rlid]','$suprow[reportlevelname]','$suprow[mgid]','$suprow[maingroup]','$suprow[subsidiaryid]','$suprow[subsidiary]','$suprow[ledgercode]','$suprow[ledger]','$_SESSION[PCDid]','$invrows[tdate]','','','$dueamounts','$dueamounts','','Purchase from  $suprow[ledger], Due Amount','1','DR','','','$companyid','','$createby','$ip','$mac','$invrows[tdate]','$timess','Cash Purchase','$inirow[invoiceno]','Normal','$day')");	


	
	
$result=mysql_query("INSERT INTO `transaction_cash` (accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,ledgercode,ledger,	VNumber,TDate,qty,rate,Amount,debitamount,creditamount,Note,SubID,journal,Person,CheckNumber,companyid,company,Username,IPAdress,	MAC,IDate,time,ttype,invoiceno,status,day) VALUES 
 ('$prow[accountreporttype]','$prow[rlid]','$prow[reportlevelname]','$prow[mgid]','$prow[maingroup]','$prow[subsidiaryid]','$prow[subsidiary]','$prow[ledgercode]','Purchase','$_SESSION[PCDid]','$invrows[tdate]','','','-$dueamounts','','$dueamounts','Purchase from  $suprow[ledger], Due Amount','0','CR','','','$companyid','','$createby','$ip','$mac','$invrows[tdate]','$timess','Cash Purchase','$inirow[invoiceno]','Normal','$day')");		
...
$result=mysql_query("INSERT INTO `transaction_cash` (accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,ledgercode,ledger,	VNumber,TDate,qty,rate,Amount,debitamount,creditamount,Note,SubID,journal,Person,CheckNumber,companyid,company,Username,IPAdress,	MAC,IDate,time,ttype,invoiceno,status,day) VALUES 
 ('$prow[accountreporttype]','$prow[rlid]','$prow[reportlevelname]','$prow[mgid]','$prow[maingroup]','$prow[subsidiaryid]','$prow[subsidiary]','$prow[ledgercode]','Purchase','$inirow[voucherno]','$invrows[tdate]','','','$amountssss','$amountssss','','Purchase from  $suprow[ledger]','1','DR','','','$companyid','','$createby','$ip','$mac','$invrows[tdate]','$timess','Cash Purchase','$inirow[invoiceno]','Normal','$day')");
 


			
	$result=mysql_query("INSERT INTO `transaction_cash` (accountreporttype,rlid,reportlevelname,mgid,maingroup,subsidiaryid,subsidiary,ledgercode,ledger,	VNumber,TDate,qty,rate,Amount,debitamount,creditamount,Note,SubID,journal,Person,CheckNumber,companyid,company,Username,IPAdress,	MAC,IDate,time,ttype,invoiceno,status,day) VALUES 
 ('$mcrow[accountreporttype]','$mcrow[rlid]','$mcrow[reportlevelname]','$mcrow[mgid]','$mcrow[maingroup]','$mcrow[subsidiaryid]','$mcrow[subsidiary]','$mcrow[ledgercode]','Main Cash','$inirow[voucherno]','$invrows[tdate]','','','-$amountssss','','$amountssss','Purchase from  $suprow[ledger]','0','CR','','','$companyid','','$createby','$ip','$mac','$invrows[tdate]','$timess','Cash Purchase','$inirow[invoiceno]','Normal','$day')");	
...
ceshexpensesid();}}					
				...
				$results=mysql_query("Select * from transaction_inventorys where  companyid='$_SESSION[companyid]' and invoiceno='$_SESSION[initiate_invoice_quotation]'");
...
$delete=mysql_query("Delete from transaction_inventorys where invoiceno='$_SESSION[initiate_invoice_quotation]' and companyid='$_SESSION[companyid]'");
  
  
$deletes=mysql_query("Delete From transaction_inventory_details where invoiceno='$_SESSION[initiate_invoice_quotation]' and companyid='$_SESSION[companyid]'");
...
<?php }} ?>
                  ...
                  <a href="quotation.php?type=delete&productcodeget=<?php echo $_GET[productcodeget] ?>&productdeletecode=<?php echo $row[id] ?>" class="btn btn-danger btn-xs"><i class="fa fa-pencil"></i> Delete </a>
 ...
 <?php 
 $qtysss=getSVALUE("transaction_inventorys", "Sum(qty) as qty", " where invoiceno='$_SESSION[initiate_invoice_quotation]' and companyid='$_SESSION[companyid]'");
 $ratesss=getSVALUE("transaction_inventorys", "Sum(rate) as rate", " where invoiceno='$_SESSION[initiate_invoice_quotation]' and companyid='$_SESSION[companyid]'");
 $amountsss=getSVALUE("transaction_inventorys", "Sum(amount) as amount", " where invoiceno='$_SESSION[initiate_invoice_quotation]' and companyid='$_SESSION[companyid]'");
 ?>                       
                        <?php } ?>
 ...
 <tr>
                      ...
                      <td align="center" ><input  type='text' id='totalPrice' class="form-control col-md-7 col-xs-12" style="text-align:center;width:100px; height:35px;" value="<?php echo $qtysss; ?>" disabled / ></td>
 ...
 <script type="text/javascript">
	...
	function calculateTotal() {
		...
		document.getElementById('dueamounts').value = totalR;
                      ...
                      <input type='hidden' id='raresoft1' name="raresoft1" autocomplete="off"  onkeyup="calculateTotal()" class="form-control col-md-7 col-xs-12" style="text-align:center;width:335px; height:35px;"  >
                      <tr><td colspan="4" style="font-weight:bold" align="right">Payment Amount</td>
                   ...
                   <input type='hidden' id='raresoft3' value="<?php echo $amountsss; ?>" class="form-control col-md-7 col-xs-12" style="text-align:center;width:335px; height:35px;" disabled / >   
                      ...
                      <td colspan="8" style="text-align:center">
					   ...
					   $deletes=mysql_query("Delete From transaction_inventorys where invoiceno='$_SESSION[initiate_invoice_quotation]' and companyid='$_SESSION[companyid]'");
