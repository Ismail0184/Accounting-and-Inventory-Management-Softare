...
//include('..pages/support_file.php');
...
function create_php_file($url,$zonename,$table_name)
{
 $my_file = $url.'.php';
                                ...
                                <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
                                    ...
                                    <br><br><br>
                                        ...
                                        <?php if($_GET[$unique]){  ?>                                            
                                            ...
                                            <div class="form-group" style="margin-left:40%">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            <button type="submit" name="record" id="record"  class="btn btn-success">Add New '.$title.'</button>
                                            </div></div>                                                                                        
                                            <?php } ?> 
